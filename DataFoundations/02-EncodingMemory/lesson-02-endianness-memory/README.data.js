...
// Source: DataFoundations/02-EncodingMemory/lesson-02-endianness-memory/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 02 — Endianness & Memory Layout (thứ tự byte và layout bộ nhớ)
