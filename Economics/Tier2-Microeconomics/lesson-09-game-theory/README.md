# Lesson 09 — Game Theory (Lý thuyết trò chơi)
...
Với A:
- Nếu B Cooperate: A Cooperate $\to -1$, A Defect $\to 0$. **Defect tốt hơn**.
- Nếu B Defect: A Cooperate $\to -10$, A Defect $\to -5$. **Defect tốt hơn**.
...
- (b) Nếu Incumbent có thể commit trước (xây dư công suất) để Fight đáng tin ($(-1, 1) \to (-2, 3)$), kết quả đổi thế nào?
...
- (c) Nếu thị trường đang ở $(\text{Standard 2}, \text{Standard 2})$ và Standard 1 ra đời, làm sao chuyển?
