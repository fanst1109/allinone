...
|---|---|---|---|---|---|---|---|
| $f'(x)$ | | $+$ | $0$ | $-$ | $0$ | $+$ | |
| $f(x)$ | | ↗ tăng | **CĐ** $(-1,\ 2)$ | ↘ giảm | **CT** $(1,\ -2)$ | ↗ tăng | |
...
| $f'(x)$ | | $+$ | $0$ | $-$ | | $-$ | $0$ | $+$ | |
| $f''(x)$ | | $-$ | | $-$ | $0$ | $+$ | | $+$ | |
| $f(x)$ | | ↗ lõm ⌢ | **CĐ** $(0,0)$ | ↘ lõm ⌢ | **uốn** $(1,-2)$ | ↘ lồi ⌣ | **CT** $(2,-4)$ | ↗ lồi ⌣ | |
...
<svg viewBox="0 0 440 270" style="max-width:440px;width:100%;height:auto;display:block;margin:14px auto;background:#f8fafc;border-radius:8px" role="img" aria-label="Đồ thị f(x) = x²/(x−1): cực đại (0,0), cực tiểu (2,4), tiệm cận đứng x = 1, tiệm cận xiên y = x + 1; lõm bên trái, lồi bên phải">
...
<line x1="110.0" y1="277.0" x2="110.0" y2="35.0"/>
<line x1="155.0" y1="277.0" x2="155.0" y2="35.0"/>
<line x1="245.0" y1="277.0" x2="245.0" y2="35.0"/>
<line x1="290.0" y1="277.0" x2="290.0" y2="35.0"/>
<line x1="335.0" y1="277.0" x2="335.0" y2="35.0"/>
<line x1="380.0" y1="277.0" x2="380.0" y2="35.0"/>
<line x1="87.5" y1="244.0" x2="407.0" y2="244.0"/>
<line x1="87.5" y1="156.0" x2="407.0" y2="156.0"/>
<line x1="87.5" y1="112.0" x2="407.0" y2="112.0"/>
<line x1="87.5" y1="68.0" x2="407.0" y2="68.0"/>
</g>
  <line x1="81.5" y1="200.0" x2="429.0" y2="200.0" stroke="#1a202c" stroke-width="1.5" marker-end="url(#ar1)"/>
  <line x1="200.0" y1="283.0" x2="200.0" y2="13.0" stroke="#1a202c" stroke-width="1.5" marker-end="url(#ar1)"/>
  <text x="421.0" y="216.0" fill="#1a202c" font-size="13" text-anchor="start" font-style="italic">x</text>
  <text x="208.0" y="23.0" fill="#1a202c" font-size="13" text-anchor="start" font-style="italic">y</text>
  <line x1="110.0" y1="196.0" x2="110.0" y2="204.0" stroke="#1a202c" stroke-width="1.5"/>
  <text x="110.0" y="216.0" fill="#475569" font-size="11" text-anchor="middle">−2</text>
  <line x1="155.0" y1="196.0" x2="155.0" y2="204.0" stroke="#1a202c" stroke-width="1.5"/>
  <text x="155.0" y="216.0" fill="#475569" font-size="11" text-anchor="middle">−1</text>
  <line x1="245.0" y1="196.0" x2="245.0" y2="204.0" stroke="#1a202c" stroke-width="1.5"/>
  <text x="245.0" y="216.0" fill="#475569" font-size="11" text-anchor="middle">1</text>
  <line x1="290.0" y1="196.0" x2="290.0" y2="204.0" stroke="#1a202c" stroke-width="1.5"/>
  <text x="290.0" y="216.0" fill="#475569" font-size="11" text-anchor="middle">2</text>
  <line x1="335.0" y1="196.0" x2="335.0" y2="204.0" stroke="#1a202c" stroke-width="1.5"/>
  <text x="335.0" y="216.0" fill="#475569" font-size="11" text-anchor="middle">3</text>
  ...
  <line x1="196.0" y1="244.0" x2="204.0" y2="244.0" stroke="#1a202c" stroke-width="1.5"/>
  <text x="193.0" y="248.0" fill="#475569" font-size="11" text-anchor="end">−2</text>
  <line x1="196.0" y1="156.0" x2="204.0" y2="156.0" stroke="#1a202c" stroke-width="1.5"/>
  <text x="193.0" y="160.0" fill="#475569" font-size="11" text-anchor="end">2</text>
  <line x1="196.0" y1="112.0" x2="204.0" y2="112.0" stroke="#1a202c" stroke-width="1.5"/>
  <text x="193.0" y="116.0" fill="#475569" font-size="11" text-anchor="end">4</text>
  <line x1="196.0" y1="68.0" x2="204.0" y2="68.0" stroke="#1a202c" stroke-width="1.5"/>
  <text x="193.0" y="72.0" fill="#475569" font-size="11" text-anchor="end">6</text>
  <path d="M 92.0,237.3 L 93.4,236.6 L 94.8,236.0 L 96.2,235.4 L 97.6,234.8 L 99.0,234.1 L 100.4,233.5 L 101.8,232.9 L 103.2,232.3 L 104.6,231.7 L 106.0,231.1 L 107.4,230.4 L 108.8,229.8 L 110.3,229.2 L 111.7,228.6 L 113.1,228.0 L 114.5,227.4 L 115.9,226.8 L 117.3,226.2 L 118.7,225.6 L 120.1,225.0 L 121.5,224.4 L 122.9,223.8 L 124.3,223.2 L 125.7,222.6 L 127.1,222.0 L 128.5,221.5 L 129.9,220.9 L 131.3,220.3 L 132.7,219.7 L 134.1,219.1 L 135.5,218.6 L 136.9,218.0 L 138.3,217.4 L 139.7,216.9 L 141.1,216.3 L 142.5,215.8 L 143.9,215.2 L 145.4,214.7 L 146.8,214.1 L 148.2,213.6 L 149.6,213.0 L 151.0,212.5 L 152.4,212.0 L 153.8,211.5 L 155.2,210.9 L 156.6,210.4 L 158.0,209.9 L 159.4,209.4 L 160.8,208.9 L 162.2,208.4 L 163.6,208.0 L 165.0,207.5 L 166.4,207.0 L 167.8,206.6 L 169.2,206.1 L 170.6,205.7 L 172.0,205.2 L 173.4,204.8 L 174.8,204.4 L 176.2,204.0 L 177.6,203.6 L 179.0,203.3 L 180.5,202.9 L 181.9,202.5 L 183.3,202.2 L 184.7,201.9 L 186.1,201.6 L 187.5,201.3 L 188.9,201.1 L 190.3,200.8 L 191.7,200.6 L 193.1,200.4 L 194.5,200.3 L 195.9,200.2 L 197.3,200.1 L 198.7,200.0 L 200.1,200.0 L 201.5,200.0 L 202.9,200.1 L 204.3,200.2 L 205.7,200.4 L 207.1,200.7 L 208.5,201.0 L 209.9,201.4 L 211.3,201.9 L 212.7,202.5 L 214.1,203.2 L 215.6,204.0 L 217.0,205.0 L 218.4,206.2 L 219.8,207.6 L 221.2,209.2 L 222.6,211.1 L 224.0,213.4 L 225.4,216.1 L 226.8,219.3 L 228.2,223.1 L 229.6,227.8 L 231.0,233.5 L 232.4,240.7" fill="none" stroke="#1d4ed8" stroke-width="2.5" stroke-linejoin="round"/>
  <path d="M 253.6,36.0 L 255.0,52.5 L 256.5,64.5 L 258.0,73.6 L 259.5,80.7 L 261.0,86.3 L 262.5,90.8 L 264.0,94.6 L 265.5,97.6 L 267.0,100.2 L 268.4,102.3 L 269.9,104.1 L 271.4,105.6 L 272.9,106.9 L 274.4,108.0 L 275.9,108.9 L 277.4,109.6 L 278.9,110.2 L 280.4,110.7 L 281.9,111.1 L 283.3,111.4 L 284.8,111.7 L 286.3,111.8 L 287.8,111.9 L 289.3,112.0 L 290.8,112.0 L 292.3,111.9 L 293.8,111.9 L 295.3,111.7 L 296.7,111.6 L 298.2,111.4 L 299.7,111.2 L 301.2,110.9 L 302.7,110.6 L 304.2,110.3 L 305.7,110.0 L 307.2,109.7 L 308.7,109.3 L 310.2,109.0 L 311.6,108.6 L 313.1,108.2 L 314.6,107.7 L 316.1,107.3 L 317.6,106.9 L 319.1,106.4 L 320.6,106.0 L 322.1,105.5 L 323.6,105.0 L 325.0,104.5 L 326.5,104.0 L 328.0,103.5 L 329.5,103.0 L 331.0,102.4 L 332.5,101.9 L 334.0,101.4 L 335.5,100.8 L 337.0,100.3 L 338.5,99.7 L 339.9,99.2 L 341.4,98.6 L 342.9,98.0 L 344.4,97.4 L 345.9,96.9 L 347.4,96.3 L 348.9,95.7 L 350.4,95.1 L 351.9,94.5 L 353.3,93.9 L 354.8,93.3 L 356.3,92.7 L 357.8,92.1 L 359.3,91.5 L 360.8,90.8 L 362.3,90.2 L 363.8,89.6 L 365.3,89.0 L 366.8,88.3 L 368.2,87.7 L 369.7,87.1 L 371.2,86.4 L 372.7,85.8 L 374.2,85.2 L 375.7,84.5 L 377.2,83.9 L 378.7,83.2 L 380.2,82.6 L 381.6,81.9 L 383.1,81.3 L 384.6,80.6 L 386.1,80.0 L 387.6,79.3 L 389.1,78.7 L 390.6,78.0 L 392.1,77.4 L 393.6,76.7 L 395.1,76.0 L 396.5,75.4 L 398.0,74.7 L 399.5,74.0 L 401.0,73.4 L 402.5,72.7" fill="none" stroke="#1d4ed8" stroke-width="2.5" stroke-linejoin="round"/>
  <line x1="245.0" y1="274.8" x2="245.0" y2="37.2" stroke="#dc2626" stroke-width="1.5" stroke-dasharray="6 4"/>
  <line x1="92.0" y1="230.8" x2="402.5" y2="79.0" stroke="#15803d" stroke-width="1.5" stroke-dasharray="6 4"/>
  <circle cx="200.0" cy="200.0" r="4" fill="#dc2626"/>
  <text x="192.0" y="192.0" fill="#dc2626" font-size="12" text-anchor="end" font-weight="700">CĐ (0, 0)</text>
  <circle cx="290.0" cy="112.0" r="4" fill="#dc2626"/>
  <text x="300.0" y="116.0" fill="#dc2626" font-size="12" text-anchor="start" font-weight="700">CT (2, 4)</text>
  <text x="251.0" y="41.6" fill="#dc2626" font-size="11" text-anchor="start">tiệm cận đứng x = 1</text>
  <text x="398.5" y="71.0" fill="#15803d" font-size="11" text-anchor="end">tiệm cận xiên y = x + 1</text>
  <text x="101.0" y="270.4" fill="#475569" font-size="11" text-anchor="start">x &lt; 1: lõm ⌢</text>
  <text x="335.0" y="173.6" fill="#475569" font-size="11" text-anchor="start">x &gt; 1: lồi ⌣</text>
  <text x="96.5" y="46.0" fill="#1d4ed8" font-size="13" text-anchor="start" font-weight="700">f(x) = x²/(x − 1)</text>
</svg>
