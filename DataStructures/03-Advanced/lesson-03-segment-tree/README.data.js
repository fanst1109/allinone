...
// Source: DataStructures/03-Advanced/lesson-03-segment-tree/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 03 — Segment Tree & Fenwick Tree
...
- [Lesson 03 — Heap](../../02-Intermediate/lesson-03-heap-priority-queue/) (về cách dùng mảng biểu diễn cây).
...
[Lesson 04 — Advanced Structures](../lesson-04-advanced-structures/)
`;
