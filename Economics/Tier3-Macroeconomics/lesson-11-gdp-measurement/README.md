...
GDP của Việt Nam 2023 ≈ `430` tỉ USD. Nghĩa là *toàn bộ những gì người Việt + doanh nghiệp trong VN sản xuất ra trong năm 2023, đo bằng giá thị trường, cộng lại = 430 tỉ USD*.
...
**Walk-through**: nước A có C=100, I=30, G=20, X=15, M=10. → GDP = `100+30+20+(15−10) = 155`.

### 2.2. Cách thu nhập (Income)

```
GDP = Lương + Lợi nhuận + Thuê + Lãi + Thuế gián thu − Trợ giá
```
...
| Năm | P_bm | Q_bm | P_áo | Q_áo |
|-----|------|------|------|------|
| 2020 (gốc) | 10 | 100 | 50 | 20 |
| 2024 | 15 | 110 | 70 | 25 |

**Nominal 2020** = `10×100 + 50×20 = 1000 + 1000 = 2000`.
**Nominal 2024** = `15×110 + 70×25 = 1650 + 1750 = 3400`.
**Real 2024** (giá năm 2020) = `10×110 + 50×25 = 1100 + 1250 = 2350`.

So sánh:
- Nominal tăng `(3400−2000)/2000 = 70%`.
- Real tăng `(2350−2000)/2000 = 17.5%`. ← đây mới là *tăng trưởng thực*.
...
Năm 2020: `100`. Năm 2024: `3400/2350 × 100 ≈ 144.7`. Lạm phát tổng quát = `~44.7%` qua 4 năm.
...
Với phần lớn nước, GDP ≈ GNI. Nhưng với Ireland (nhiều công ty đa quốc gia đặt trụ sở pháp lý), GNI < GDP nhiều.
...
Nước A: GDP = `100` tỉ, dân = `10` triệu, Gini = 0.25.
Nước B: GDP = `200` tỉ, dân = `10` triệu, Gini = 0.55.
...
GDP = `500 + 120 + 80 + (90 − 110) = 700 − 20 = 680`.

### Lời giải Bài 2

(a) Nominal 2022 = `5×1000 + 8×500 = 5000 + 4000 = 9000`. Nominal 2025 = `7×1100 + 10×600 = 7700 + 6000 = 13700`.

(b) Real 2025 (giá 2022) = `5×1100 + 8×600 = 5500 + 4800 = 10300`.

(c) Deflator 2025 = `13700/10300 × 100 ≈ 133`.

(d) Tăng trưởng thực = `(10300 − 9000)/9000 ≈ 14.4%`.

### Lời giải Bài 3

GDP = `500` (giá hàng cuối). Hoặc: giá trị gia tăng `200 + 150 + 150 = 500`. ✓
