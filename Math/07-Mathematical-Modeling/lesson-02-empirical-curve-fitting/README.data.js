...
Dữ liệu 5 điểm: (1, 2), (2, 3), (3, 5), (4, 4), (5, 6).
...
> - **R² = 1 − 1.90/10 = 0.81** → đường giải thích 81% biến động.
...
**Bài 1.** Cho 4 điểm (1, 1), (2, 2), (3, 2), (4, 5). Tìm đường hồi quy bình phương tối thiểu ŷ = ax + b.

**Bài 2.** Với kết quả Bài 1, tính R² và diễn giải.
...
**Bài 4.** Dữ liệu nghi theo mũ y = A·e^(kx): (0, 3), (1, 6), (2, 12), (3, 24). Dùng tuyến tính hóa (lấy ln) để tìm A và k. (Gợi ý: dữ liệu này "đẹp" — gấp đôi mỗi bước.)
...
- → **ŷ = 1.2x − 0.5**. Kiểm: tại x̄ = 2.5, ŷ = 1.2·2.5 − 0.5 = 2.5 = ȳ ✓ (qua trọng tâm).
...
- **R² = 1 − 1.80/9.0 = 1 − 0.20 = 0.80** → đường giải thích 80% biến động; 20% còn lại là nhiễu/lệch (chủ yếu từ điểm (3,2) lệch −1.1).
...
**Bài 4.** Lấy Y = ln y: (0, ln3=1.099), (1, ln6=1.792), (2, ln12=2.485), (3, ln24=3.178). Khoảng cách đều nhau 0.693 = ln2 → độ dốc k = 0.693 → **k = ln 2 ≈ 0.693**. Tung độ gốc = 1.099 = ln 3 → **A = 3**. Vậy y = 3·e^(0.693x) = 3·2ˣ. Kiểm: x=2 → 3·4 = 12 ✓; x=3 → 3·8 = 24 ✓. (Đúng là "gấp đôi mỗi bước".)
