...
- **"Sẵn sàng"** = muốn (willingness). Bạn muốn mua xe Lamborghini nhưng không đủ tiền $\to$ không thuộc cầu.
- **"Có khả năng"** = có ngân sách (ability). Có tiền nhưng không muốn $\to$ cũng không thuộc cầu.

Cầu CHỈ tồn tại khi cả hai điều kiện đồng thời.

#### 💡 Trực giác / Hình dung

Hình dung bạn đứng trước quầy trà sữa. Nếu giá 10k/ly, bạn sẵn sàng mua **5 ly** (uống cả ngày). Giá tăng lên 20k/ly $\to$ bạn còn mua **3 ly**. 40k/ly $\to$ chỉ **1 ly**. 100k/ly $\to$ **0 ly**. Bảng (giá $\to$ lượng mua) này chính là **cầu cá nhân** của bạn cho trà sữa.

**Cầu thị trường** = tổng tất cả cầu cá nhân ở mỗi mức giá. Nếu thị trường có 1.000 người giống bạn, cầu thị trường $= 1000 \times$ cầu cá nhân.
...
1. **Hiệu ứng thay thế (substitution effect)**: giá trà sữa tăng $\to$ bạn chuyển một phần sang cà phê (rẻ hơn tương đối).
2. **Hiệu ứng thu nhập (income effect)**: giá tăng $\to$ thu nhập thực (sức mua) của bạn giảm $\to$ bạn mua ít đi nói chung.
...
**Hàm cầu tuyến tính**: nhiều bài toán mô hình hóa cầu bằng hàm bậc nhất $Q_d = a - b \cdot P$, với $a > 0$, $b > 0$. Walk-through:
...
- **Nhầm "lượng cầu" với "cầu"**: *Lượng cầu* là một con số tại một mức giá; *cầu* là **cả bảng** giá - lượng. Khi giá đổi $\to$ *lượng cầu* đổi (di chuyển dọc đường). Khi yếu tố khác đổi $\to$ *cầu* đổi (dịch chuyển cả đường). Sẽ học sâu ở §4.
...
**Q: Có hàng hóa nào *không* tuân theo quy luật cầu?** Có, gọi là **hàng Giffen** (Giffen goods) — vd lúa mì trong nạn đói Ireland thế kỷ 19: giá lúa mì tăng $\to$ người nghèo *mua nhiều lúa mì hơn* vì không còn đủ tiền cho thịt. Hàng Veblen (Rolex, hàng hiệu) cũng có thể có cầu *tăng theo giá* do tâm lý "đắt = sang". Đây là ngoại lệ, không phải luật.
...
1. $Q_d = 20 - 0.5 \times 30 = 20 - 15 = 5$ cốc/tuần.
2. "Giá tối đa cho cốc đầu tiên" = mức giá làm $Q_d = 0$ chính là *prohibitive price*. $0 = 20 - 0.5P \to P = 40k$. Đây cũng chính là **willingness to pay** cao nhất.
</details>

#### 📝 Tóm tắt mục 1

- Cầu = bảng (giá $\to$ lượng mua), với điều kiện *sẵn sàng + có khả năng*.
- Quy luật cầu: $P\uparrow \to Q_d\downarrow$.
...
1. **Chi phí biên tăng dần**: sản xuất thêm 1 đơn vị càng về sau càng tốn kém (đất tốt hết $\to$ phải dùng đất xấu; lao động giỏi hết $\to$ phải tuyển lao động kém hơn). Chỉ khi giá đủ cao mới đáng sản xuất thêm.
2. **Người bán mới gia nhập**: giá cao thu hút thêm người làm $\to$ tổng cung thị trường tăng.
...
Nếu giá thị trường là 10.000đ/kg $\to$ bạn chỉ trồng trên mảnh tốt (mảnh khác lỗ).
Nếu giá lên 20.000đ/kg $\to$ bạn trồng cả mảnh tốt + trung bình.
Nếu giá lên 35.000đ/kg $\to$ bạn trồng cả 3 mảnh.

Đây là cơ chế gốc của quy luật cung: **giá cao = đáng làm thêm = cung nhiều hơn**.

### 2.2. Walk-through bằng số

**Hàm cung tuyến tính** $Q_s = c + d \cdot P$, với $c, d$ là hằng số ($d > 0$ — cung tăng theo giá).
...
- Cung = bảng (giá $\to$ lượng bán).
- Quy luật cung: $P\uparrow \to Q_s\uparrow$.
...
- **Giá quá cao** ($P > P^*$): $Q_s > Q_d$ $\to$ hàng tồn kho dư $\to$ người bán giảm giá để tống hàng $\to$ giá giảm về $P^*$.
- **Giá quá thấp** ($P < P^*$): $Q_d > Q_s$ $\to$ người mua tranh giành $\to$ người bán tăng giá $\to$ giá tăng về $P^*$.
...
$$\begin{aligned}
\text{Cầu:}\quad & Q_d = 100 - 2P \\
\text{Cung:}\quad & Q_s = -10 + 2P
\end{aligned}$$
...
Thay vào $Q$: $Q^* = 100 - 2 \times 27.5 = 100 - 55 = 45$.

Kiểm tra: $Q_s = -10 + 2 \times 27.5 = 45$ ✓.

**Cân bằng**: $(P^*, Q^*) = (27.5,\ 45)$.

**Xét trường hợp giá bị áp đặt sai**:

- Nếu $P = 30 > P^*$: $Q_d = 100 - 60 = 40$; $Q_s = -10 + 60 = 50$. **Dư cung 10 đơn vị** — hàng tồn $\to$ áp lực giảm giá.
- Nếu $P = 20 < P^*$: $Q_d = 100 - 40 = 60$; $Q_s = -10 + 40 = 30$. **Thiếu hụt 30 đơn vị** — người mua xếp hàng $\to$ áp lực tăng giá.

Bốn ví dụ thị trường thật:

1. **Khẩu trang COVID đầu 2020**: Cầu tăng đột biến (dịch bệnh) $\to$ đường cầu dịch phải mạnh $\to$ giá tăng $\to$ cung tăng đáp lại $\to$ cân bằng mới ở giá cao và lượng cao hơn.
2. **Giá dầu thô 2014-2016**: Cung shale oil Mỹ tăng mạnh $\to$ đường cung dịch phải $\to$ giá rớt từ \$100 $\to$ \$30/thùng.
3. **Bất động sản TP.HCM 2008**: Cầu giảm do khủng hoảng tài chính $\to$ giá giảm 30-50%.
4. **Vé concert Taylor Swift**: Cung cố định (sức chứa sân vận động) $\to$ cung gần như thẳng đứng $\to$ giá cân bằng cực cao + thị trường thứ cấp (scalping).
...
Hình dung đường cầu là một sợi dây cao su gắn trên hệ trục. Tay bạn (giá) trượt dọc dây $\to$ di chuyển dọc đường. Có người *kéo cả sợi dây* sang phải / trái $\to$ đường cầu dịch chuyển.

### 4.2. Yếu tố làm dịch chuyển *cầu*

1. **Thu nhập (income)**:
   - Hàng *bình thường (normal good)*: thu nhập tăng $\to$ cầu tăng (đường cầu dịch phải). Vd: ăn uống ở nhà hàng.
   - Hàng *thấp cấp (inferior good)*: thu nhập tăng $\to$ cầu *giảm*. Vd: mì gói (giàu lên $\to$ bớt ăn mì gói).
2. **Giá hàng liên quan**:
   - Hàng *thay thế (substitute)*: giá hàng thay thế tăng $\to$ cầu hàng này tăng. Vd: giá Pepsi tăng $\to$ cầu Coca tăng.
   - Hàng *bổ sung (complement)*: giá hàng bổ sung tăng $\to$ cầu hàng này giảm. Vd: giá xăng tăng $\to$ cầu ô tô giảm.
3. **Sở thích (preferences)**: trào lưu, quảng cáo, sức khỏe... Vd: xu hướng ăn keto $\to$ cầu bơ tăng.
4. **Kỳ vọng (expectations)**: dự đoán giá tương lai. Vd: kỳ vọng giá xăng ngày mai tăng $\to$ cầu hôm nay tăng (đổ xăng đầy).
5. **Số lượng người mua**: dân số tăng $\to$ cầu tăng.

### 4.3. Yếu tố làm dịch chuyển *cung*

1. **Giá yếu tố đầu vào** (input prices): nguyên liệu, lao động, năng lượng. Vd: giá thép tăng $\to$ cung ô tô giảm.
2. **Công nghệ**: cải tiến $\to$ giảm chi phí $\to$ cung tăng (dịch phải). Vd: smartphone — công nghệ chip rẻ hơn $\to$ giá điện thoại rẻ hơn cho cùng cấu hình.
3. **Kỳ vọng**: kỳ vọng giá mai cao $\to$ cung *hôm nay* giảm (giữ hàng).
...
- **"Cung khẩu trang giảm vì giá quá cao"**: SAI. Giá cao $\to$ *lượng cung tăng* (chứ không phải cung giảm).
...
- Đường cầu dịch *phải* mạnh $\to$ cả $P^*$ và $Q^*$ đều tăng nhiều.
- Đường cung dịch *phải* nhưng chậm $\to$ góp phần giảm áp lực giá.

**Kết quả thực tế**: Giá khẩu trang đầu 2020 tăng 5-10 lần. Đến giữa 2021, cung đuổi kịp $\to$ giá quay lại bình thường.

#### 🔁 Dừng lại tự kiểm tra

Khi nào các sự kiện sau làm dịch chuyển *đường* (shift), khi nào chỉ di chuyển *dọc đường* (movement)?

1. Giá cà phê thế giới tăng $\to$ tác động lên thị trường cà phê.
2. Người dân chuộng đồ uống lành mạnh hơn $\to$ tác động lên thị trường nước ngọt.
3. Đường tăng giá $\to$ tác động lên thị trường nước ngọt (vì nước ngọt dùng đường).

<details>
<summary>Đáp án</summary>

1. Giá *chính* cà phê tăng $\to$ **di chuyển dọc đường** cầu/cung của cà phê (lượng cầu giảm, lượng cung tăng).
2. Sở thích thay đổi $\to$ **dịch chuyển trái đường cầu** nước ngọt (cầu giảm ở mọi mức giá).
3. Giá đầu vào tăng $\to$ **dịch chuyển trái đường cung** nước ngọt (cung giảm ở mọi mức giá).
</details>

#### 📝 Tóm tắt mục 4

- *Lượng* đổi khi giá đổi $\to$ di chuyển dọc đường.
- *Cả đường* đổi khi yếu tố khác đổi $\to$ dịch chuyển.
...
- Nếu trần giá *trên* $P^*$ $\to$ vô tác dụng (thị trường vẫn cân bằng ở $P^*$ hợp lệ).
- Nếu trần giá *dưới* $P^*$ (binding) $\to$ tạo **thiếu hụt** ($Q_d > Q_s$ ở mức trần).
...
- Nếu sàn giá *dưới* $P^*$ $\to$ vô tác dụng.
- Nếu sàn giá *trên* $P^*$ (binding) $\to$ tạo **dư cung** ($Q_s > Q_d$ ở mức sàn).
...
**Trong thị trường lao động**: lương tối thiểu trên mức cân bằng $\to$ một số người muốn làm việc với lương đó nhưng không có chỗ $\to$ **thất nghiệp**.
...
**(a)** Đặt $Q_d = Q_s$: $200 - 5P = -40 + 3P \to 240 = 8P \to P^* = 30k$. Thay vào: $Q^* = 200 - 150 = 50$ nghìn đơn vị. Kiểm tra: $Q_s = -40 + 90 = 50$ ✓.

**(b)** $P = 25k < P^* = 30k \to$ thiếu hụt. $Q_d = 200 - 125 = 75$; $Q_s = -40 + 75 = 35$. **Thiếu hụt $= 75 - 35 = 40$ nghìn đơn vị**.

**(c)** Cầu mới: $240 - 5P = -40 + 3P \to 280 = 8P \to P^* = 35k$. $Q^* = 240 - 175 = 65$ nghìn đơn vị. Cả giá và lượng đều tăng — đúng với dự đoán khi cầu dịch phải.

### Lời giải Bài 2

**(a)** Trần $P = 20k < P^* = 30k \to$ **binding** (có tác động).

**(b)** Tại $P = 20$: $Q_d = 200 - 100 = 100$; $Q_s = -40 + 60 = 20$. **Thiếu hụt $= 80$ nghìn đơn vị**.

**(c)** Hậu quả phụ:

1. **Chợ đen**: người mua sẵn sàng trả giá cao hơn 20k $\to$ giao dịch lén lút ở giá cao hơn.
2. **Xếp hàng / phân phối theo quan hệ**: ai xếp hàng lâu nhất / quen biết người bán mới mua được — phân bổ nguồn lực không hiệu quả.

### Lời giải Bài 3

1. **Cà phê** — sở thích thay đổi (lợi sức khỏe) $\to$ **dịch chuyển PHẢI đường cầu** cà phê.
2. **Cà phê** — yếu tố đầu vào (sản lượng tự nhiên) giảm $\to$ **dịch chuyển TRÁI đường cung** cà phê.
3. **Cà phê** — hàng thay thế (trà) đắt hơn $\to$ **dịch chuyển PHẢI đường cầu** cà phê (chuyển từ trà sang).
4. **Cà phê** — *giá chính* tăng $\to$ **di chuyển dọc đường** cầu (lượng cầu giảm) + **di chuyển dọc đường** cung (lượng cung tăng). KHÔNG phải dịch chuyển.

### Lời giải Bài 4

**(a) Ngắn hạn**: cung gần thẳng đứng. Trần giá $\to$ giá giảm $\to$ lượng cầu tăng đột biến. Thiếu hụt nhà thuê. Người được thuê ở giá rẻ thì lợi; nhiều người khác không tìm được nhà.

**(b) Dài hạn**: cung co lại đáng kể. Chủ đất chuyển nhà sang bán, sang Airbnb (nếu được), hoặc bỏ bê không sửa chữa (vì doanh thu thấp). Đường cung dịch *trái* $\to$ thiếu hụt *trầm trọng hơn* về lâu dài. Nhà thuê chất lượng kém đi (vì chủ không có incentive sửa). Đây là kịch bản nhiều thành phố Mỹ và châu Âu đã chứng kiến (San Francisco, Stockholm).

**(c) Chính sách tốt hơn**:

- **Trợ cấp tiền thuê (housing voucher)** trực tiếp cho người thu nhập thấp $\to$ tăng *cầu của họ* mà không méo mó giá thị trường.
- **Tăng cung** bằng giảm hạn chế xây dựng, cho phép mật độ cao hơn (zoning reform) $\to$ giảm $P^*$ cân bằng.
