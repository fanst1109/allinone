...
- **Bắt buộc**: [`Math/01-Arithmetic-Algebra`](../Math/01-Arithmetic-Algebra/) (modular arithmetic), [`DataFoundations/01-NumberRepresentation`](../DataFoundations/01-NumberRepresentation/) (binary, hex, XOR), [`DataFoundations/03-MathFoundations`](../DataFoundations/03-MathFoundations/) (boolean).
