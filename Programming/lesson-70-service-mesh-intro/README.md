...
> ⚠ **Lỗi thường gặp.** Istio mạnh nhưng **dốc học**: rất nhiều CRD (VirtualService, DestinationRule, Gateway, PeerAuthentication, AuthorizationPolicy...), nhiều cách cấu hình chồng chéo. Đừng "bật full Istio" ngày đầu — bắt đầu từ mTLS + metric, thêm dần.
