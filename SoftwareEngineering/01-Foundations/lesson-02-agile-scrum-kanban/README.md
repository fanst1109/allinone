...
- [Lesson 01 — Vòng đời phần mềm (SDLC) & vai trò kỹ sư](../lesson-01-sdlc-engineer-role/) — đặc biệt **mục 4 (mô hình lặp & tăng dần)** và **mục 6 (vai trò trong nhóm)**. Bài này cụ thể hóa "mô hình lặp" thành cách làm việc nhóm hằng ngày.
...
(Nối tiếp [Lesson 01 — mục 6 vai trò](../lesson-01-sdlc-engineer-role/): PO ≈ Product Manager, Dev Team gồm Software Engineer + QA.)
...
- [Lesson 03 — Yêu cầu & đặc tả](../lesson-03-requirements-spec/) — đi sâu vào giai đoạn *Yêu cầu* của SDLC: viết user story, acceptance criteria, làm rõ nhu cầu mơ hồ (chính là thứ "đổ" vào Product Backlog của Scrum).
- Quay lại nền tảng: [Lesson 01 — SDLC & vai trò kỹ sư](../lesson-01-sdlc-engineer-role/) (mô hình lặp & vai trò nhóm).
