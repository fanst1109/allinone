# Lesson 08 — Đa dạng sinh học & bảo tồn
...
- Tính được hai chỉ số đo đa dạng loài thông dụng: **chỉ số Shannon (Shannon diversity index)** $H = -\sum_i p_i \ln(p_i)$ và **chỉ số Simpson (Simpson index)** $D = 1 - \sum_i p_i^2$, kèm thước đo **độ đều (evenness)**.
...
**Ví dụ 1 — Tỉ lệ đã mô tả**: $1{,}9 / 8{,}7 = \mathbf{0{,}218 \approx 21{,}8\%}$. Nghĩa là gần 80% loài trên Trái Đất *chưa được khoa học biết tên*.

**Ví dụ 2 — Khoảng còn lại**: $8{,}7 - 1{,}9 = \mathbf{6{,}8}$ **triệu** loài chưa mô tả. Với tốc độ ~15.000 loài/năm hiện nay, cần $6\,800\,000 / 15\,000 \approx 453$ năm để mô tả hết — nhưng nhiều loài có thể đã tuyệt chủng trước khi được mô tả.
...
Gọi $p_i$ = tỉ lệ cá thể của loài $i$ trong tổng. Hai chỉ số chính:

- **Shannon H** = $-\sum_i p_i \ln(p_i)$
  - Đơn vị: nats (vì dùng $\ln$). Đôi khi dùng $\log_2$ → đơn vị bits.
  - $H = 0$ khi chỉ có 1 loài. $H$ đạt cực đại $\ln(S)$ khi $S$ loài chia đều ($p_i = 1/S$ cho mọi $i$).
- **Simpson D** = $1 - \sum_i p_i^2$
  - Diễn giải: xác suất 2 cá thể nhặt ngẫu nhiên thuộc 2 loài khác nhau.
  - $D = 0$ khi chỉ 1 loài; $D \to 1$ khi rất nhiều loài chia đều.
- **Độ đều (evenness)** = $H / \ln(S) \in [0, 1]$. Bằng 1 khi tất cả loài chia hoàn toàn đều.

### 3.2. Walk-through bằng số cụ thể

**Khu A — 3 loài, tỉ lệ 0,5 / 0,3 / 0,2**:

$$H = -[0{,}5 \cdot \ln(0{,}5) + 0{,}3 \cdot \ln(0{,}3) + 0{,}2 \cdot \ln(0{,}2)]$$

Tính từng số hạng:
- $\ln(0{,}5) \approx -0{,}693$ → $0{,}5 \times (-0{,}693) = -0{,}347$
- $\ln(0{,}3) \approx -1{,}204$ → $0{,}3 \times (-1{,}204) = -0{,}361$
- $\ln(0{,}2) \approx -1{,}609$ → $0{,}2 \times (-1{,}609) = -0{,}322$

Tổng: $-0{,}347 + (-0{,}361) + (-0{,}322) = -1{,}030$. Vậy $H = -(-1{,}030) = \mathbf{1{,}030}$ **nats**.

$D = 1 - (0{,}5^2 + 0{,}3^2 + 0{,}2^2) = 1 - (0{,}25 + 0{,}09 + 0{,}04) = 1 - 0{,}38 = \mathbf{0{,}62}$.

Độ đều = $1{,}030 / \ln(3) = 1{,}030 / 1{,}099 = \mathbf{0{,}937}$ — khá đều.

**Khu B — 3 loài, tỉ lệ 0,96 / 0,02 / 0,02** (cùng số loài nhưng lệch):

- $0{,}96 \cdot \ln(0{,}96) \approx 0{,}96 \times (-0{,}0408) = -0{,}0392$
- $0{,}02 \cdot \ln(0{,}02) \approx 0{,}02 \times (-3{,}912) = -0{,}0782$ (×2 vì có 2 loài cùng tỉ lệ) → $-0{,}1565$

Tổng: $-0{,}0392 - 0{,}1565 = -0{,}1957$. $H = \mathbf{0{,}196}$ **nats**.

$D = 1 - (0{,}96^2 + 0{,}02^2 + 0{,}02^2) = 1 - (0{,}9216 + 0{,}0004 + 0{,}0004) = \mathbf{0{,}0776}$.

Độ đều = $0{,}196 / 1{,}099 = \mathbf{0{,}178}$ — rất lệch.

**So sánh**: cùng 3 loài, A đa dạng gấp $1{,}030 / 0{,}196 \approx 5{,}3$ lần B theo Shannon. Đây là minh chứng "số loài giống nhau không có nghĩa đa dạng giống nhau" (§1).

**Khu C — 4 loài chia hoàn toàn đều, $p_i = 0{,}25$**:

$H = -4 \times 0{,}25 \times \ln(0{,}25) = -1 \times (-1{,}386) = \mathbf{1{,}386}$ **nats** $= \ln(4)$ ✓ (cực đại).

$D = 1 - 4 \times 0{,}0625 = 1 - 0{,}25 = \mathbf{0{,}75}$.

**Khu D — chỉ 1 loài ($p_i = 1$)**:

$H = -1 \times \ln(1) = 0$. $D = 1 - 1^2 = 0$. Đa dạng bằng 0 — đơn loài.
...
- **Quên dấu trừ trong Shannon**: vì $p_i < 1$ nên $\ln(p_i) < 0$. Quên dấu trừ → $H$ âm (vô lý).
- **Trộn đơn vị**: nếu dùng $\log_2$ thay $\ln$, $H$ tính ra khác (đơn vị bits). Khi so sánh hai nghiên cứu phải kiểm tra cùng đơn vị.
...
1. $H = -2 \times 0{,}5 \times \ln(0{,}5) = -1 \times (-0{,}693) = \mathbf{0{,}693}$ **nats**. $D = 1 - 2 \times 0{,}25 = \mathbf{0{,}5}$. Độ đều = $0{,}693 / \ln(2) = 0{,}693 / 0{,}693 = \mathbf{1{,}0}$ (hoàn toàn đều — không thể đều hơn).
2. $H = \ln(5) = \mathbf{1{,}609}$ **nats**. $D = 1 - 5 \times (1/5)^2 = 1 - 1/5 = \mathbf{0{,}8}$. Đây là giá trị tối đa cho 5 loài.

</details>

### 📝 Tóm tắt mục 3

- **Shannon $H = -\sum p_i \ln p_i$** đo "lượng bất ngờ trung bình"; cực đại = $\ln(S)$.
- **Simpson $D = 1 - \sum p_i^2$** = xác suất 2 cá thể ngẫu nhiên là 2 loài khác nhau.
- **Độ đều $= H / \ln(S) \in [0, 1]$**. Cùng số loài có thể chênh nhau hơn 5 lần khi độ đều khác nhau.
...
**Ví dụ 4**: Loài có nguy cơ trong sách đỏ IUCN (2022): trong ~150.000 loài được đánh giá, ~28% bị xếp vào diện bị đe dọa (vulnerable, endangered, critically endangered). Suy ra $0{,}28 \times 8{,}7 \text{ triệu} \approx 2{,}4$ triệu loài có thể đang bị đe dọa nếu tỉ lệ này áp cho toàn bộ.
...
1. Tốc độ nền: $1/1\,000\,000 \times 8\,700\,000 = 8{,}7$ loài/năm. Trong 100 năm: $8{,}7 \times 100 = \mathbf{870}$ **loài**.
2. Nhanh gấp 500: $8{,}7 \times 500 = 4\,350$ loài/năm. Trong 100 năm: $4\,350 \times 100 = \mathbf{435\,000}$ **loài** — hơn nửa triệu loài mất trong 1 thế kỷ.
...
(b) Shannon:
- $0{,}40 \cdot \ln(0{,}40) = 0{,}40 \times (-0{,}916) = -0{,}367$
- $0{,}30 \cdot \ln(0{,}30) = 0{,}30 \times (-1{,}204) = -0{,}361$
- $0{,}20 \cdot \ln(0{,}20) = 0{,}20 \times (-1{,}609) = -0{,}322$
- $0{,}10 \cdot \ln(0{,}10) = 0{,}10 \times (-2{,}303) = -0{,}230$
- Tổng = $-0{,}367 - 0{,}361 - 0{,}322 - 0{,}230 = -1{,}280$.
- $\mathbf{H = 1{,}280}$ **nats**.

(c) Simpson:
- $0{,}40^2 + 0{,}30^2 + 0{,}20^2 + 0{,}10^2 = 0{,}16 + 0{,}09 + 0{,}04 + 0{,}01 = 0{,}30$.
- $\mathbf{D = 1 - 0{,}30 = 0{,}70}$.

(d) Độ đều = $H / \ln(S) = 1{,}280 / \ln(4) = 1{,}280 / 1{,}386 = \mathbf{0{,}923}$ — khá đều nhưng chưa tối đa.

**Bài 2**:

- **Khu A** (chia đều): $H = \ln(5) \approx \mathbf{1{,}609}$ **nats** (giá trị cực đại cho 5 loài).
- **Khu B**:
  - $0{,}8 \cdot \ln(0{,}8) = 0{,}8 \times (-0{,}223) = -0{,}179$
  - $0{,}05 \cdot \ln(0{,}05) = 0{,}05 \times (-2{,}996) = -0{,}150$ (×4 vì có 4 loài cùng tỉ lệ) → $-0{,}599$
  - Tổng = $-0{,}179 - 0{,}599 = -0{,}778$.
  - $H \approx \mathbf{0{,}778}$ **nats**.
...
(a) Tốc độ nền: $(1 / 1\,000\,000) \times 8\,700\,000 = 8{,}7$ loài/năm. Hiện tại gấp 200 → $8{,}7 \times 200 = \mathbf{1\,740}$ **loài/năm**.

(b) Trong 50 năm: $1\,740 \times 50 = \mathbf{87\,000}$ **loài**.

(c) Tỉ lệ: $87\,000 / 8\,700\,000 = 0{,}01 = \mathbf{1{,}0\%}$ tổng số loài Trái Đất trong nửa thế kỷ.
...
2. **Đo đa dạng loài**:
   - **Shannon $H = -\sum p_i \ln p_i$** (cực đại = $\ln(S)$).
   - **Simpson $D = 1 - \sum p_i^2$** = xác suất 2 cá thể là 2 loài khác nhau.
   - **Độ đều $= H / \ln(S) \in [0,1]$**. Cùng số loài có thể khác đa dạng > 5 lần khi độ đều khác.
