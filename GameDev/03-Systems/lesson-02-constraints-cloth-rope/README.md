# Lesson 12 — Constraints: Cloth & Rope (ràng buộc — dây, vải, ragdoll)
...
- Sau đó **ép** mỗi ràng buộc: tính $diff = (dist - L)/dist$, dịch $A$ thêm $+0.5 \cdot d \cdot diff$, $B$ thêm $-0.5 \cdot d \cdot diff$.
