...
- $D = (0,\\infty)$, cắt trục x tại $(1,0)$; tăng **chậm** (x nhân a thì y chỉ +1).
- Đối số phải $> 0$.
...
|-----|--------|---|---|----------------|
| $y = ax + b$ | Đường thẳng | $\\mathbb{R}$ | $\\mathbb{R}$ | $a > 0$ |
| $y = ax^2 + bx + c$ | Parabol | $\\mathbb{R}$ | $[y_{min}, \\infty)$ hoặc $(-\\infty, y_{max}]$ | (1/2 đồ thị) |
| $y = a^x$ | Cong mũ | $\\mathbb{R}$ | $(0, \\infty)$ | $a > 1$ |
| $y = \\log_a(x)$ | Cong log | $(0, \\infty)$ | $\\mathbb{R}$ | $a > 1$ |
