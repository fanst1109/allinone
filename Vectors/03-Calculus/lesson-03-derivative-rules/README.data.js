...
// Source: Vectors/03-Calculus/lesson-03-derivative-rules/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 03 — Quy tắc đạo hàm (Derivative Rules)
...
- [Algebra Lesson 07 — Lũy thừa và log](../../01-Algebra/lesson-07-exponentials-logs/): tính chất \`a^x = e^(x·ln a)\`.
...
- 🔗 Liên quan:
  ...
  - [Trigonometry Lesson 05 — Identities](../../02-Trigonometry/lesson-05-identities-cosine-law/) — định lý Pythagore \`sin² + cos² = 1\` dùng trong chứng minh \`(tan)' = sec²\`.
- 🔭 Sẽ gặp lại:
