...
// Source: Electronics/01-Fundamentals/lesson-01-voltage-current-resistance/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 01 — Điện áp, Dòng điện, Điện trở
...
- Nắm vững **Định luật Ohm V = I·R** — nền tảng của mọi phân tích mạch điện.
- Tính **công suất điện P = V·I = I²R = V²/R**, đơn vị Watt (W).
...
- Electron mang điện tích âm: q = −1.6 × 10⁻¹⁹ C.
- Proton mang điện tích dương: q = +1.6 × 10⁻¹⁹ C.
...
- mA (miliampe) = 10⁻³ A — dùng cho mạch điện tử nhỏ
- µA (microampe) = 10⁻⁶ A — dùng cho cảm biến, vi mạch
...
- Ví dụ 2: Bóng đèn LED 20 mA hoạt động trong 1 giờ = 3600 s. Q = I·t = 0.020 × 3600 = **72 C** điện tích đã đi qua.
- Ví dụ 3: Máy sạc điện thoại 2 A trong 1.5 giờ. Q = 2 × 5400 = **10,800 C ≈ 3 Ah**.
- Ví dụ 4: Lò vi sóng 5 A, hoạt động 3 phút. Q = 5 × 180 = **900 C**.
...
- Đơn vị thực tế: mA (10⁻³ A), µA (10⁻⁶ A).
- 1 Coulomb ≈ 6.24 × 10¹⁸ electron đi qua mặt cắt.
...
**Liên hệ Physics**: Điện áp V chính là hiệu điện thế (potential difference) ΔV = V_A − V_B giữa hai điểm A và B. Điện tích dương di chuyển từ nơi thế cao sang thế thấp.

**Đơn vị thực tế**:
- mV (milivolt) = 10⁻³ V — tín hiệu cảm biến nhỏ
- V (Volt) — pin, nguồn thông thường
- kV (kilovolt) = 10³ V — đường dây cao thế

**Bốn ví dụ số**:

- Ví dụ 1: Pin AA = **1.5 V**. Để đẩy 1 C qua mạch, pin cấp 1.5 J năng lượng.
- Ví dụ 2: Nguồn USB = **5 V**. Sạc điện thoại với Q = 10,800 C → W = V·Q = 5 × 10,800 = **54,000 J = 54 kJ** năng lượng cấp.
...
Đáp: Vì da khô có điện trở rất cao (~100 kΩ), dòng qua người = 9V / 100,000Ω = 0.09 mA — quá nhỏ để gây nguy hiểm. Nguy hiểm bắt đầu từ ~10 mA qua tim. Điện 220V AC nguy hiểm vì ngay cả với da khô vẫn tạo ra dòng đủ lớn.
...
**Đơn vị thực tế**:
- Ω (Ohm) — giá trị nhỏ
- kΩ (kilohm) = 10³ Ω — phổ biến nhất trong mạch điện tử
- MΩ (megaohm) = 10⁶ Ω — điện trở rất lớn
...
- **ρ** (rho): điện trở suất (resistivity) của vật liệu, đơn vị Ω·m.
- **L**: chiều dài dây (m) — dài hơn → R lớn hơn.
- **A**: tiết diện ngang (m²) — rộng hơn → R nhỏ hơn (ít cản hơn).

| Vật liệu | ρ (Ω·m) | Đặc điểm |
|----------|---------|-----------|
| Đồng (Cu) | 1.68 × 10⁻⁸ | Dây dẫn phổ biến nhất |
| Nhôm (Al) | 2.82 × 10⁻⁸ | Nhẹ hơn Cu, dùng đường dây cao thế |
| Vonfram (W) | 5.6 × 10⁻⁸ | Dây tóc bóng đèn |
| Nichrome | 1.1 × 10⁻⁶ | Dây điện trở trong bếp điện |
| Silicon | ~640 | Bán dẫn — giữa dẫn điện và cách điện |
| Thủy tinh | ~10¹² | Cách điện |

**Ý nghĩa thực tế của R = ρL/A**:
...
- Ví dụ 1: Dây đồng dài L = 10 m, tiết diện A = 1 mm² = 10⁻⁶ m². R = 1.68×10⁻⁸ × 10 / 10⁻⁶ = **0.168 Ω**.
- Ví dụ 2: Cùng dây nhưng dài gấp đôi (L = 20 m): R = **0.336 Ω** (tuyến tính theo L).
- Ví dụ 3: Dây đồng L = 1 m, tiết diện tăng lên A = 4 mm² = 4×10⁻⁶ m²: R = 1.68×10⁻⁸ × 1 / 4×10⁻⁶ = **0.0042 Ω** — tiết diện 4× thì R giảm 4×.
- Ví dụ 4: Điện trở Nichrome dùng trong bếp điện: L = 2 m, A = 0.5 mm² = 5×10⁻⁷ m². R = 1.1×10⁻⁶ × 2 / 5×10⁻⁷ = **4.4 Ω** — điện trở cao chủ đích để tỏa nhiệt.

⚠ **Lỗi thường gặp**: Nhầm lẫn giữa điện trở suất ρ (thuộc tính vật liệu) và điện trở R (thuộc tính của một linh kiện cụ thể). Cùng vật liệu (ρ như nhau) nhưng dây dài và ngắn có R khác nhau.
...
R = ρ·L/A = 1.68×10⁻⁸ × 5 / (2×10⁻⁶) = 8.4×10⁻⁸ / 2×10⁻⁶ = **0.042 Ω**
...
- R = ρL/A — phụ thuộc vật liệu, chiều dài, tiết diện.
- Đơn vị thực tế: Ω, kΩ, MΩ.
- Đồng có ρ rất nhỏ (dẫn điện tốt); điện trở Nichrome có ρ lớn (tỏa nhiệt).
...
I = V / R = 5 / 330 = **0.01515 A ≈ 15.15 mA**
...
R = V / I = 12 / 0.024 = **500 Ω** → Chọn điện trở gần nhất trên dãy chuẩn E24: 510 Ω.
...
I = V / R = 3.3 / 10,000 = **0.00033 A = 0.33 mA = 330 µA**
...
I = V / R = 3.3 / 4700 = 0.000702 A = **0.702 mA**

</details>

### 📝 Tóm tắt mục 4

- Định luật Ohm: V = I·R (hay I = V/R, R = V/I).
...
Kết hợp với V = I·R, suy ra 3 dạng công thức tương đương:

\`\`\`
P = V · I          (dạng cơ bản)
P = I² · R         (khi biết I và R)
P = V² / R         (khi biết V và R)
\`\`\`
...
**Dạng 1** (dùng I² · R):
P = I² × R = (0.05)² × 220 = 0.0025 × 220 = **0.55 W**

**Dạng 2** (tính V trước rồi dùng V · I):
V = I × R = 0.05 × 220 = 11 V
P = V × I = 11 × 0.05 = **0.55 W** ✓ (kết quả đồng nhất)
...
**Nguyên tắc thiết kế thực hành**: Chọn điện trở có công suất định mức **ít nhất gấp 2 lần** công suất tính toán (derating 50%). Với bài trên: P_tính = 0.55 W → chọn điện trở **1 W** để an toàn.

**Bốn ví dụ số tiếp theo**:

- Ví dụ 1: LED cần 20 mA, điện trở giới hạn 150 Ω. P = (0.02)² × 150 = **0.06 W = 60 mW** → điện trở 1/8 W (125 mW) là đủ.
- Ví dụ 2: Điện trở pull-up 10 kΩ trên đường tín hiệu 5 V. P = V²/R = 25/10,000 = **0.0025 W = 2.5 mW** — cực kỳ nhỏ, 1/8 W dư sức.
- Ví dụ 3: Cầu chia áp 2 điện trở 1 kΩ, nguồn 12 V. Tổng R = 2 kΩ, I = 12/2000 = 6 mA. P mỗi điện trở = I²×R = (0.006)² × 1000 = **0.036 W = 36 mW** → 1/8 W đủ.
- Ví dụ 4: Mạch hàn chì dùng điện trở 10 Ω, dòng 500 mA. P = (0.5)² × 10 = **2.5 W** → phải dùng điện trở 5W có tản nhiệt, không phải loại nhỏ 1/4 W.
...
P = V² / R = 9² / 470 = 81 / 470 = **0.172 W = 172 mW**
...
- P = V·I = I²·R = V²/R. Đơn vị Watt (W).
- Công suất định mức điện trở: 1/8 W, 1/4 W, 1/2 W, 1 W, 2 W, 5 W...
- Nguyên tắc derating: chọn điện trở có P_định_mức ≥ 2 × P_tính_toán.
...
**Bài 1**: Dây điện trong nhà dài 15 m, tiết diện 1.5 mm², làm bằng đồng (ρ = 1.68×10⁻⁸ Ω·m). Tính điện trở của đoạn dây (cả đi và về = 2 dây).
...
**Cho**: L = 15 m (một chiều), tiết diện A = 1.5 mm² = 1.5×10⁻⁶ m², ρ = 1.68×10⁻⁸ Ω·m, 2 dây (đi + về).

**Bước 1**: Điện trở 1 dây dài 15 m:
R₁ = ρ × L / A = 1.68×10⁻⁸ × 15 / 1.5×10⁻⁶ = 2.52×10⁻⁷ / 1.5×10⁻⁶ = **0.168 Ω**

**Bước 2**: Tổng điện trở 2 dây (nối tiếp):
R_tổng = 2 × 0.168 = **0.336 Ω**

**Nhận xét**: Nhỏ, nhưng với dòng lớn (vd 10 A cho bình nóng lạnh), sụt áp = 0.336 × 10 = 3.36 V — đáng kể. Đây là lý do dây điện gia dụng công suất lớn phải dùng tiết diện lớn.
...
**Cho**: V_nguồn = 5 V, V_LED = 2 V → điện áp rơi trên R = 5 − 2 = 3 V. I = 15 mA = 0.015 A.

**Bước 1**: Tính R:
R = V_R / I = 3 / 0.015 = **200 Ω** → chọn giá trị chuẩn E24 gần nhất: **200 Ω** (hoặc 220 Ω cho an toàn hơn — dòng sẽ nhỏ hơn một chút).

**Bước 2**: Công suất tiêu thụ:
P = V_R × I = 3 × 0.015 = **0.045 W = 45 mW**

**Bước 3**: Chọn công suất định mức: Áp dụng derating 50%: cần P_định_mức ≥ 2 × 45 mW = 90 mW → chọn **1/8 W (125 mW)** là đủ an toàn.

### Bài 4

**Cho**: R1 = R2 = 10 kΩ = 10,000 Ω, VCC = 3.3 V.

**Bước 1**: Tổng điện trở:
R_tổng = R1 + R2 = 20,000 Ω = 20 kΩ

**Bước 2**: Dòng qua mạch:
I = VCC / R_tổng = 3.3 / 20,000 = **0.000165 A = 0.165 mA = 165 µA**

**Bước 3**: Điện áp tại điểm giữa (= điện áp rơi trên R2):
V_mid = I × R2 = 0.000165 × 10,000 = **1.65 V**

(Cũng có thể tính: V_mid = VCC × R2 / (R1 + R2) = 3.3 × 10/20 = 1.65 V — công thức chia áp.)

**Bước 4**: Công suất tổng:
P = VCC × I = 3.3 × 0.000165 = **0.000545 W ≈ 0.545 mW**

Rất nhỏ — mạch chia áp thụ động tiêu tốn rất ít điện.

### Bài 5

**Cho**: R = 100 Ω, P_định_mức = 1/4 W = 0.25 W.

**Bước 1**: Dòng tối đa theo công suất định mức:
Từ P = I²·R → I = √(P/R) = √(0.25/100) = √(0.0025) = **0.05 A = 50 mA**

**Bước 2**: Áp dụng derating 50% → dòng an toàn thực tế:
I_an_toàn = 50 mA × 50% = **25 mA**

**Nhận xét**: Không bao giờ cho dòng vượt 25 mA qua điện trở 100 Ω / 1/4 W này nếu muốn điện trở hoạt động tin cậy lâu dài.

### Bài 6

**Cho**: V_nguồn = 5 V, V_pin = 3.7 V, R = 15 Ω, P_định_mức = 1/2 W = 0.5 W.

**Bước 1**: Điện áp rơi trên R:
V_R = V_nguồn − V_pin = 5 − 3.7 = 1.3 V

**Bước 2**: Dòng nạp:
I = V_R / R = 1.3 / 15 = **0.0867 A ≈ 86.7 mA**

**Bước 3**: Công suất trên điện trở:
P = V_R × I = 1.3 × 0.0867 = **0.113 W = 113 mW**

**Bước 4**: Kiểm tra công suất định mức 1/2 W:
P_tính = 113 mW. Derating 50%: cần P_định_mức ≥ 226 mW. 1/2 W = 500 mW > 226 mW → **không cần tản nhiệt**, điện trở 1/2 W là thoải mái.
...
3. **Điện trở R = V/I = ρL/A** (Ohm). Phụ thuộc vật liệu, chiều dài, tiết diện.
4. **Định luật Ohm V = I·R** — luôn đổi đơn vị về SI trước khi tính.
5. **Công suất P = V·I = I²R = V²/R** (Watt). Chọn điện trở có P_định_mức ≥ 2 × P_tính toán.
`;
