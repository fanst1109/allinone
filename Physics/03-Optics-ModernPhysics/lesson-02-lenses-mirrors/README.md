...
- Áp dụng **phương trình thấu kính mỏng**: $\frac{1}{f} = \frac{1}{d_o} + \frac{1}{d_i}$.
...
- **(b) Vì sao cần**: f tóm gọn toàn bộ "sức mạnh quang học" của một thấu kính vào MỘT con số, để ta tính được vị trí ảnh cho mọi vị trí vật mà không cần biết hình dạng cong chi tiết của thấu kính. Độ tụ $P = 1/f$ (đơn vị diop, $\text{m}^{-1}$) là cách kính cận/viễn được kê đơn.
- **(c) Ví dụ số kèm đơn vị**: kính lúp $f = 10 \text{ cm}$. Chùm nắng song song qua nó hội tụ thành điểm cháy cách kính đúng 10 cm. Độ tụ $P = 1/0{,}1 \text{ m} = +10 \text{ diop}$.
...
**Trường hợp 1**: vật ở $d_o = 30 \text{ cm}$ (xa hơn $2f = 20 \text{ cm}$):
- $\frac{1}{d_i} = \frac{1}{10} - \frac{1}{30} = \frac{3}{30} - \frac{1}{30} = \frac{2}{30} \to d_i =$ **$15 \text{ cm}$** (sau thấu kính).
- $m = -15/30 =$ **$-0{,}5$** (ảnh thật, ngược, nhỏ hơn). 
- → Đây là cách máy ảnh hoạt động: vật xa → ảnh thật ngược, nhỏ trên cảm biến.

**Trường hợp 2**: vật ở $d_o = 5 \text{ cm}$ (gần hơn $f = 10 \text{ cm}$):
- $\frac{1}{d_i} = \frac{1}{10} - \frac{1}{5} = \frac{1}{10} - \frac{2}{10} = -\frac{1}{10} \to d_i =$ **$-10 \text{ cm}$**.
...
- **Cộng nhầm $\frac{1}{f} = \frac{1}{d_o} - \frac{1}{d_i}$.** Công thức đúng là $\frac{1}{f} = \frac{1}{d_o} + \frac{1}{d_i}$ (cộng). Dấu âm chỉ xuất hiện qua việc d_i tự mang dấu âm khi ảnh ảo.
...
1. Thấu kính lồi $f = 12 \text{ cm}$, vật ở $d_o = 24 \text{ cm}$. Tính $d_i$ và $m$. Ảnh thật hay ảo?
2. Thấu kính phân kỳ $f = -15 \text{ cm}$, vật ở $d_o = 30 \text{ cm}$. $d_i$ dương hay âm?

<details><summary>Đáp án</summary>

1. $\frac{1}{d_i} = \frac{1}{12} - \frac{1}{24} = \frac{2}{24} - \frac{1}{24} = \frac{1}{24} \to d_i = 24 \text{ cm}$ ($>0$ → **ảnh thật**). $m = -24/24 = -1$ → ảnh ngược chiều, cùng kích thước. (Vật ở đúng 2f → ảnh ở 2f, bằng vật, lộn ngược.)
2. $\frac{1}{d_i} = \frac{1}{-15} - \frac{1}{30} = -\frac{2}{30} - \frac{1}{30} = -\frac{3}{30} = -\frac{1}{10} \to d_i = -10 \text{ cm}$. **Âm** → ảnh ảo (thấu kính phân kỳ luôn cho ảnh ảo với vật thật).
...
Phương trình tương tự thấu kính: **$\frac{1}{f} = \frac{1}{d_o} + \frac{1}{d_i}$**. Tiêu cự liên hệ bán kính: **$f = R/2$**.
...
- *"Gương dùng cùng công thức $\frac{1}{f} = \frac{1}{d_o} + \frac{1}{d_i}$ với thấu kính sao?"* Đúng, công thức giống hệt. Khác biệt: với gương, ảnh thật nằm cùng phía vật (phía trước gương, vì ánh sáng bị bật ngược lại); với thấu kính, ảnh thật nằm phía sau.
...
- **Quên đổi R sang f.** Đề cho $R = 40 \text{ cm}$ thì $f = 20 \text{ cm}$, KHÔNG phải 40 cm.

🔁 **Dừng lại tự kiểm tra**

1. Gương cầu lõm có $R = 30 \text{ cm}$. Tiêu cự bằng bao nhiêu?
2. Gương chiếu hậu xe là loại gương cầu gì, và vì sao?

<details><summary>Đáp án</summary>

1. $f = R/2 = 30/2 = 15 \text{ cm}$ (dương vì gương lõm hội tụ).
...
- Gương cầu: $\frac{1}{f} = \frac{1}{d_o} + \frac{1}{d_i}$, $f = R/2$.
...
- Tổng độ phóng $= m_{\text{vật kính}} \times m_{\text{thị kính}}$. Có thể đạt 1000×.
...
- Độ phóng $= f_{\text{vật kính}} / f_{\text{thị kính}}$.
...
- *"Độ phóng đại kính hiển vi và viễn vọng tính khác nhau sao?"* Hiển vi: $m = m_{\text{vật}} \times m_{\text{thị}}$ (tích hai độ phóng tuyến tính). Viễn vọng: $M = f_{\text{vật}} / f_{\text{thị}}$ (tỉ số hai tiêu cự) — vì vật ở vô cực nên đo độ phóng GÓC.
...
- **Tưởng kính viễn vọng dùng thị kính f lớn.** Ngược lại: vật kính f LỚN, thị kính f NHỎ → $M = f_{\text{vật}}/f_{\text{thị}}$ lớn. Đặt ngược → $M < 1$ (thu nhỏ).

🔁 **Dừng lại tự kiểm tra**

1. Một người nhìn gần (đọc sách) bị mờ, nhìn xa rõ. Bị tật gì, đeo kính loại nào?
2. Kính viễn vọng có $f_{\text{vật}} = 80 \text{ cm}$, $f_{\text{thị}} = 4 \text{ cm}$. Độ phóng đại?

<details><summary>Đáp án</summary>

1. Nhìn gần mờ = **viễn thị (hyperopia)** → đeo kính **hội tụ** ($f > 0$).
2. $M = f_{\text{vật}}/f_{\text{thị}} = 80/4 = 20\times$.
...
**Bài 1**: Thấu kính hội tụ $f = 20 \text{ cm}$. Vật cao 5 cm đặt ở $d_o = 60 \text{ cm}$. Tính $d_i$, $m$, kích thước ảnh.

**Bài 2**: Vật ở $d_o = 5 \text{ cm}$ trước thấu kính lồi $f = 8 \text{ cm}$. Tính $d_i$ và $m$.

**Bài 3**: Kính lúp $f = 5 \text{ cm}$. Vật ở $d_o = 3 \text{ cm}$. Tính độ phóng đại.

**Bài 4**: Người bị cận thị nhìn xa nhất được 50 cm (không đeo kính). Tính f của kính cần đeo để nhìn xa ($\infty$).

**Bài 5**: Kính viễn vọng có $f_{\text{vật}} = 100 \text{ cm}$, $f_{\text{thị}} = 5 \text{ cm}$. Tính độ phóng đại.

### Lời giải

**Bài 1**: $\frac{1}{d_i} = \frac{1}{20} - \frac{1}{60} = \frac{3}{60} - \frac{1}{60} = \frac{2}{60} \to d_i =$ **$30 \text{ cm}$** (sau thấu kính, ảnh thật). $m = -30/60 =$ **$-0{,}5$** (ngược, nhỏ hơn 1/2). $h_i = m \cdot h_o = -0{,}5 \cdot 5 =$ **$-2{,}5 \text{ cm}$** (cao 2,5 cm, ngược).

**Bài 2**: $\frac{1}{d_i} = \frac{1}{8} - \frac{1}{5} = \frac{5}{40} - \frac{8}{40} = -\frac{3}{40} \to d_i =$ **$-13{,}33 \text{ cm}$** (ảo, cùng phía vật). $m = -(-13{,}33)/5 =$ **$+2{,}67$** (ảo, cùng chiều, lớn 2,67 lần).

**Bài 3**: $\frac{1}{d_i} = \frac{1}{5} - \frac{1}{3} = \frac{3}{15} - \frac{5}{15} = -\frac{2}{15} \to d_i =$ **$-7{,}5 \text{ cm}$** (ảo). $m = -(-7{,}5)/3 =$ **$+2{,}5$** (phóng đại 2,5×).

**Bài 4**: Cần kính phân kỳ làm vật ở $\infty$ "hiện ra" ở 50 cm. $\frac{1}{-50} = \frac{1}{f} + \frac{1}{\infty} \to \frac{1}{f} = -\frac{1}{50} \to$ **$f = -50 \text{ cm}$** (phân kỳ).

**Bài 5**: $M = f_{\text{vật}} / f_{\text{thị}} = 100/5 =$ **$20\times$**.
...
2. **$\frac{1}{f} = \frac{1}{d_o} + \frac{1}{d_i}$**, $m = -d_i/d_o$.
3. **Ảnh thật $d_i > 0$** (chiếu màn) vs **ảnh ảo $d_i < 0$** (chỉ nhìn).
4. **Gương cầu**: $\frac{1}{f} = \frac{1}{d_o} + \frac{1}{d_i}$, $f = R/2$.
