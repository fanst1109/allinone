...
// Source: Compilers/03-Backend/lesson-04-control-flow-codegen/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 14 — Sinh mã điều khiển luồng (Control Flow Codegen: if/while → jumps)
