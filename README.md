...
| Japanese | Tiếng Nhật tới JLPT N5 — 3 nhánh × 12 bài: phát âm & Kana (Hiragana/Katakana, mora, pitch) → Kanji & từ vựng → ngữ pháp (trợ từ, です・ます, động từ/tính từ). Audio Web Speech API ja-JP | [Japanese/](./Japanese/) |
