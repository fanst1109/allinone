...
- **System 2**: chủ động, chậm, lý tính, tốn năng lượng. Vd: nhân $17 \\times 24$.
...
Phần lớn người chọn (i) ở A — *risk-averse* với *lợi*. Nhưng cũng chọn (iv) ở B — *risk-loving* với *mất*. Dù 2 tình huống *kết quả cuối cùng giống nhau* ($+1500$ vs $+2000 \\pm 1000$).
...
$$v(x) = \\begin{cases} x^\\alpha & \\text{nếu } x \\ge 0 \\ (\\text{gain}) \\\\ -\\lambda(-x)^\\beta & \\text{nếu } x < 0 \\ (\\text{loss}) \\end{cases}$$

$\\lambda \\approx 2\\text{-}2.5$ — mất đau gấp $2\\text{-}2.5$ lần lợi tương đương. $\\alpha, \\beta \\approx 0.88$ — lõm khi gain, lồi khi loss.
...
1. **Default options**: Áo, Pháp (mặc định ĐĂNG KÝ hiến tạng, ai không muốn opt-out) có tỉ lệ hiến $> 90\\%$. Đức (mặc định KHÔNG, ai muốn opt-in) có tỉ lệ $\\approx 12\\%$. Cùng dân số tương tự, khác duy nhất ở mặc định.
...
4. **Calorie label**: hiển thị calorie ở menu → giảm trung bình $\\approx 5\\%$ calo người dùng order.
...
Cho $\\lambda = 2.25, \\alpha = \\beta = 0.88$. Tính:
- (a) $v(+1000)$.
- (b) $v(-1000)$.
...
(a) $v(+1000) = 1000^{0.88} \\approx 468$.
(b) $v(-1000) = -2.25 \\times 1000^{0.88} \\approx -1053$.
(c) $0.5 \\times 468 + 0.5 \\times (-1053) = 234 - 526.5 = -292.5$.
(d) $v(\\text{bet}) < 0$ → tránh bet, dù *kỳ vọng giá trị tiền* $= 0$. Đây là **loss aversion** — mất $1000$ đau gấp đôi lợi $1000$ vui.
