...
(c) Session key không gửi trực tiếp vì nghe lén sẽ thu được nó. Thay vào đó, ECDHE cho phép cả 2 bên **độc lập tính ra cùng một giá trị** từ thông tin trao đổi công khai (A=a·G, B=b·G) — kẻ thứ 3 thấy A, B nhưng không tính được S = a·b·G.
