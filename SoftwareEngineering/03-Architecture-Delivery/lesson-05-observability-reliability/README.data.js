...
// Source: SoftwareEngineering/03-Architecture-Delivery/lesson-05-observability-reliability/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 05 — Observability & độ tin cậy
...
- [Lesson 04 — Container & triển khai](../lesson-04-containers-deployment/): hiểu cách dịch vụ chạy trong container và được đưa lên production — observability chính là cách ta "nhìn vào trong" những container đang chạy đó.
...
- Liên quan: [Lesson 03 — CI/CD](../lesson-03-ci-cd/) (rollback nhanh để giảm MTTR) và [Lesson 04 — Container & triển khai](../lesson-04-containers-deployment/) (cái mà observability quan sát).
`;
