...
- **(c) Ví dụ trực giác**: từ 1 phân tử DNA, sau 30 chu kỳ PCR → 2³⁰ ≈ 10⁹ bản sao = ~1 nanogram DNA, đủ để chạy điện di hoặc giải trình tự.
...
Mỗi chu kỳ **gấp đôi** số bản sao. Sau **n chu kỳ** từ 1 phân tử ban đầu → **2ⁿ** bản sao (giả định hiệu suất 100%).
...
**Bài toán ngược**: cần 1 triệu bản sao từ 1 phân tử → cần ít nhất **log₂(10⁶) ≈ 20 chu kỳ**.

Trong thực tế, hiệu suất ~80-95%/chu kỳ chứ không 100% → công thức chính xác hơn: \`N = N₀ × (1 + E)ⁿ\`, với E là hiệu suất khuếch đại.
...
1. 3 × 2²⁵ = 3 × 33,554,432 = **100,663,296 bản sao** (~10⁸).
2. Cần 2ⁿ ≥ 10⁹ → n ≥ log₂(10⁹) ≈ 9 × log₂(10) ≈ 9 × 3.32 = 29.9 → **30 chu kỳ** (giả định hiệu suất 100%).
</details>
...
Cần \`5 × 2ⁿ ≥ 10⁹\` → \`2ⁿ ≥ 2×10⁸\` → \`n ≥ log₂(2×10⁸) = 1 + log₂(10⁸) ≈ 1 + 26.6 = 27.6\`.

→ Cần ít nhất **28 chu kỳ**. Kiểm tra: 5 × 2²⁸ = 5 × 268,435,456 ≈ 1.34×10⁹ ✓.
...
Tính: log₁₀(1.9³⁰) = 30 × log₁₀(1.9) = 30 × 0.2788 = 8.36 → 1.9³⁰ ≈ 10^8.36 ≈ **2.3×10⁸ bản sao**.

So với hiệu suất 100% (2³⁰ ≈ 1.07×10⁹): thiếu **~4.6 lần** (1.07×10⁹ / 2.3×10⁸ ≈ 4.6). Hiệu suất giảm 10% mỗi chu kỳ tích lũy thành chênh lệch lớn sau nhiều chu kỳ.
...
5. **PCR**: 3 bước/chu kỳ (denature 95°C → anneal mồi ~55°C → extend bởi Taq 72°C). Sau n chu kỳ → **2ⁿ bản sao**. 30 chu kỳ ≈ 10⁹ bản sao.
