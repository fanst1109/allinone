...
// Source: Chemistry/01-Structure/lesson-05-molecular-geometry-vsepr/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 05 — Hình học phân tử (VSEPR)
...
- Áp dụng được cho > 15 phân tử thường gặp: CO₂, H₂O, NH₃, CH₄, BF₃, SF₆, PCl₅, XeF₄...
...
- 2 bóng: nằm thẳng (180°).
- 3 bóng: tam giác phẳng (120°).
- 4 bóng: tứ diện đều (109.5°).
- 5 bóng: lưỡng tháp tam giác.
- 6 bóng: bát diện đều (90°).
...
**Hình học cặp electron**: thẳng hàng, góc 180°.

**Phân tử minh họa**: CO₂, BeCl₂, HCN, C₂H₂.
...
### 2.2. SN = 3 → Trigonal Planar (120°)

**Hình học cặp electron**: tam giác đều phẳng, góc 120°.

**Phân tử minh họa**: BF₃, AlCl₃, BCl₃, formaldehyde (HCHO).
...
### 2.3. SN = 4 → Tetrahedral (109.5°)

**Hình học cặp electron**: tứ diện đều, góc 109.5°.

**Phân tử minh họa**: CH₄, NH₄⁺, SiH₄, CCl₄.
...
**Hình học cặp electron**: lưỡng tháp tam giác. **Không đồng đều**: 3 vị trí "xích đạo" (equatorial, 120° giữa nhau) + 2 vị trí "đỉnh" (axial, 90° so với equatorial).

**Phân tử minh họa**: PCl₅, PF₅, AsF₅.
...
### 2.5. SN = 6 → Octahedral (90°)

**Hình học cặp electron**: bát diện đều, 6 đỉnh đối xứng, mọi góc lân cận đều 90°.

**Phân tử minh họa**: SF₆, SeF₆, PCl₆⁻.
...
| 3 | 1 | Tetrahedral | **Trigonal pyramidal** (chóp tam giác) | ~ 107° | NH₃, PH₃ |
| 2 | 2 | Tetrahedral | **Bent (gấp khúc)** | ~ 104.5° | H₂O, H₂S |

**Quan sát**: cùng SN = 4 nhưng hình học phân tử khác nhau khi có lone pair. Góc giảm dần: 109.5° → 107° → 104.5°.

### 💡 Trực giác — NH₃ và H₂O

**NH₃**: 3 H ở 3 đỉnh "đáy" của tứ diện, lone pair ở đỉnh thứ 4 (đỉnh "trên"). Phân tử có hình **chóp tam giác** (tripod), giống cái dù che đầu.

**H₂O**: 2 H ở 2 đỉnh đối diện đáy, 2 lone pair ở 2 đỉnh còn lại. Phân tử có hình **gấp khúc** (V-shape, bent).
...
1. Tính SN và xác định hình học của: SF₄.
2. Tại sao H₂O có góc 104.5° trong khi CH₄ có 109.5°?

<details>
<summary>Đáp án</summary>

1. SF₄: S là trung tâm. Đếm cặp e ngoài cùng của S: 6 (S nhóm VIA). 4 e dùng làm liên kết với 4 F (4 bonding pair) → còn 6 − 4 = 2 e = 1 lone pair. **SN = 4 + 1 = 5**. Hình học cặp e: trigonal bipyramidal. Có 1 lone pair → hình học phân tử: **see-saw**.

2. Cả 2 đều SN = 4 (tetrahedral cặp e). CH₄ không lone pair → đối xứng đều → 109.5°. H₂O có 2 lone pair → 2 cặp đẩy mạnh hơn bonding → 2 H bị "ép" lại → góc thu hẹp xuống 104.5°.
</details>
...
1. Lewis: O=C=O. Trung tâm C, 2 liên kết đôi, 0 lone pair.
...
| 3 | 0 | Trigonal planar | Trigonal planar | 120° | BF₃, AlCl₃, HCHO |
| 3 | 1 | Trigonal planar | Bent | ~ 119° | SO₂, O₃ |
| 4 | 0 | Tetrahedral | Tetrahedral | 109.5° | CH₄, CCl₄, NH₄⁺ |
| 4 | 1 | Tetrahedral | Trigonal pyramidal | ~ 107° | NH₃, PH₃, H₃O⁺ |
...
**Bài 1**: Xác định SN, hình học cặp e, hình học phân tử của: CH₄, NH₃, H₂O, BF₃, SF₆.

**Bài 2**: Phân tử nào có cực và phân tử nào không cực: CO₂, H₂O, CCl₄, NH₃, CH₃Cl?

**Bài 3**: Vì sao H₂O có moment lưỡng cực ≠ 0 mà CO₂ thì = 0, mặc dù cả 2 đều có liên kết phân cực?

**Bài 4**: Dự đoán hình học của PF₅ và XeF₄.

**Bài 5**: NO₂ có liên kết đặc biệt — vẽ Lewis và dự đoán hình học. (Gợi ý: 17 e tổng → có 1 e lẻ trên N.)

**Bài 6**: Tại sao PCl₅ tồn tại nhưng NCl₅ thì không?
...
|---------|---------|------|----|------------------|---------------------|
| CH₄ | 4 | 0 | 4 | Tetrahedral | Tetrahedral |
| NH₃ | 3 | 1 | 4 | Tetrahedral | Trigonal pyramidal |
| H₂O | 2 | 2 | 4 | Tetrahedral | Bent |
| BF₃ | 3 | 0 | 3 | Trigonal planar | Trigonal planar |
| SF₆ | 6 | 0 | 6 | Octahedral | Octahedral |

**Bài 2**:
- **CO₂**: linear, 2 dipole C=O đối xứng → triệt tiêu → KHÔNG cực.
- **H₂O**: bent, 2 dipole O-H không đối xứng → CÓ cực.
- **CCl₄**: tetrahedral đối xứng (4 Cl giống nhau) → 4 dipole triệt tiêu → KHÔNG cực.
- **NH₃**: trigonal pyramidal, 3 dipole N-H + lone pair → tổng ≠ 0 → CÓ cực.
- **CH₃Cl**: tetrahedral nhưng KHÔNG đối xứng (1 Cl, 3 H) → CÓ cực.

**Bài 3**: 
- **CO₂**: 2 dipole C=O hướng ngược nhau (vì phân tử linear) → triệt tiêu → moment lưỡng cực tổng = 0.
- **H₂O**: 2 dipole O-H hướng cùng phía (vì phân tử bent, 104.5°) → không triệt tiêu → moment lưỡng cực ≠ 0 → nước có cực.

→ Bài học: **hình học quyết định moment lưỡng cực**, không phải chỉ độ phân cực từng liên kết.

**Bài 4**:
- **PF₅**: P có 5 e ngoài cùng. Tất cả dùng làm 5 liên kết với 5 F. Không lone pair. SN = 5. Hình học: **trigonal bipyramidal**.
- **XeF₄**: Xe nhóm VIIIA, có 8 e ngoài. 4 e dùng cho 4 liên kết với F, 4 e còn lại = 2 lone pair. SN = 6. Hình học cặp e: octahedral. Hình học phân tử: **square planar** (2 lone pair ở 2 đỉnh đối, 4 F ở mặt phẳng giữa).

**Bài 5**:
- NO₂ có tổng e = 5 + 2 × 6 = 17 e (số lẻ! → radical).
...
- Hình học: gần trigonal planar nhưng méo. Góc O-N-O ≈ 134° (giữa bent của ozone 117° và tuyến tính 180°).

**Bài 6**: 
- **P** (chu kỳ 3) có **phân lớp 3d trống**, có thể "mở rộng octet" tới 10 e ngoài cùng → tạo được PCl₅ với 5 liên kết.
- **N** (chu kỳ 2) chỉ có 2s và 2p (không có 2d!) → giới hạn 8 e ngoài cùng → tối đa 4 liên kết → KHÔNG tạo được NCl₅.
