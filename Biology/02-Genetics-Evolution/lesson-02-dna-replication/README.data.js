...
- **Tính tỉ lệ lai trên tổng là (1/2ⁿ)**: gần đúng nhưng không chính xác — phải là 2/2ⁿ = 1/2^(n−1).
...
\`\`\`
t = (chiều dài genome) / (số chạc × tốc độ mỗi chạc)
\`\`\`
...
- t = (genome size) / (2k × v), với k = số origin, v = tốc độ mỗi chạc.
...
6. **Lượng hóa**: t = genome / (2k × v). E. coli: 1 origin, ~38 phút. Người: ~30,000 origin, ~8 giờ pha S. Sai sót cuối ~10⁻⁹ nhờ 3 lớp sửa lỗi.
