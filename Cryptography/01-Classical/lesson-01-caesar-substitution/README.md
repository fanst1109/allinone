# Lesson 01: Caesar Cipher & Monoalphabetic Substitution
...
- Bảng chữ cái A–Z và phép toán modular cơ bản (a mod 26).
...
ROT13 lại: U=20 → (20+13) mod 26 = 7 = H ✓
```

ROT13 là self-inverse vì 13 + 13 = 26 ≡ 0 mod 26.

**Ví dụ 3 — Decrypt Caesar k=7, ciphertext "AOPZPZH":**

```
A = 0  → (0  − 7 + 26) mod 26 = 19 = T
O = 14 → (14 − 7 + 26) mod 26 =  7 = H
P = 15 → (15 − 7 + 26) mod 26 =  8 = I
Z = 25 → (25 − 7 + 26) mod 26 = 18 = S
P = 15 → (15 − 7 + 26) mod 26 =  8 = I
Z = 25 → (25 − 7 + 26) mod 26 = 18 = S
H = 7  → (7  − 7 + 26) mod 26 =  0 = A
...
> ⚠ **Lỗi thường gặp**: Quên mod 26 khi Z + k > 25. Ví dụ Z=25, k=3: 25+3=28 → 28 mod 26 = 2 = C, KHÔNG phải 28 hay Z+3.
...
> - *"k=0 có phải cipher không?"* — Có, nhưng C ≡ P — mọi cipher đều có trường hợp trivial.
...
Số hoán vị 26 chữ cái = 26! = 403,291,461,126,605,635,584,000,000 ≈ 4 × 10²⁶.

So sánh:
- AES-128 key space: 2¹²⁸ ≈ 3.4 × 10³⁸ (lớn hơn nhiều).
- 26! ≈ 2⁸⁸ — tương đương key 88 bit.
...
Bước 3 — Tìm bigram: JV xuất hiện 4 lần → JV ≈ TH hoặc HE → nếu J=E thì JV = EV → "ER" hoặc "EN" hoặc "EX"? Thử V=R.

Bước 4 — Tìm trigram JZL: nếu J=E thì EZL → "AND" → Z=A, L=N? Kiểm tra nhất quán.
...
- Brute force 26! keys bằng máy tính: ∼ 4×10²⁶ phép tính → không khả thi với thử từng key.
...
>
> W=22 → (22+17) mod 26 = 39 mod 26 = 13 = N
> O=14 → (14+17) mod 26 = 31 mod 26 = 5 = F
> R=17 → (17+17) mod 26 = 34 mod 26 = 8 = I
> L=11 → (11+17) mod 26 = 28 mod 26 = 2 = C
> D= 3 → (3+17)  mod 26 = 20 mod 26 = 20 = U
>
> Kết quả: "WORLD" → "NFICU"
> </details>
>
...
> 📝 **Tóm tắt mục 1–4**:
> - Caesar cipher: C = (P+k) mod 26, chỉ 26 key → brute-force trivial.
> - ROT13 (k=13) là self-inverse vì 13+13 ≡ 0 mod 26.
> - Substitution cipher: key space 26! ≈ 2⁸⁸, nhưng frequency analysis của Al-Kindi phá được.
...
Kiểm lại chính xác:
```
C(2)→H(7), R(17)→W(22), Y(24)→D(3), P(15)→U(20), T(19)→Y(24),
A(0)→F(5), N(13)→S(18), A(0)→F(5), L(11)→Q(16), Y(24)→D(3),
S(18)→X(23), I(8)→N(13), S(18)→X(23)
```
