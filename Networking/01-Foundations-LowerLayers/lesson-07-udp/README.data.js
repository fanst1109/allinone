...
// Source: Networking/01-Foundations-LowerLayers/lesson-07-udp/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 07 — Tầng giao vận: UDP
...
(c) Overhead $= (86 - 40) / 40 \\times 100 = \\frac{46}{40} \\times 100 =$ **115%** — nghĩa là overhead còn nhiều hơn payload! Đây là lý do gói nhỏ (game position update) cần payload đủ lớn để overhead hợp lý.
...
\`\`\`
TCP overhead so với UDP: $145\\% - 115\\% =$ **thêm 30%** ($12 \\text{ byte header} \\times 100/40$). Hoặc đơn giản: TCP header 20B vs UDP 8B $\\to$ 12 byte thêm $/$ 40 byte payload $= +30\\%$.
...
(c) 20 DNS query:
- UDP: $20 \\times 30 =$ **600 ms**
- TCP: $20 \\times 60 =$ **1200 ms**
- Tiết kiệm: **600 ms** (bằng nửa thời gian). Với RTT cao hơn (quốc tế ~150ms), tiết kiệm càng lớn.
