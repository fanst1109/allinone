...
// Source: Vectors/04-LinearAlgebra/lesson-03-norm-distance/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 03 — Norm và khoảng cách
...
Vector này hướng 45° — trùng với \`(cos 45°, sin 45°)\`. Nhắc lại từ [Trigonometry](../../02-Trigonometry/) — mọi vector unit 2D đều có dạng \`(cos θ, sin θ)\`.
...
- **Cross-tier**:
  ...
  - [Tầng 2 — Trigonometry](../../02-Trigonometry/) — vector unit \`(cos θ, sin θ)\`.
