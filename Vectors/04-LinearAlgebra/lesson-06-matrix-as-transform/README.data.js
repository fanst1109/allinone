...
// Source: Vectors/04-LinearAlgebra/lesson-06-matrix-as-transform/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 06 — Ma trận = biến đổi (Linear Transformation)
...
- [Tầng 2 Trigonometry — Lesson 06: Rotation matrix](../../02-Trigonometry/lesson-06-rotation-matrix/) — đã gặp ma trận xoay \`R(θ)\` ở đó; bài này chính thức hóa và mở rộng.
- [Tầng 1 Algebra — Lesson 08: Hệ phương trình tuyến tính](../../01-Algebra/lesson-08-linear-systems/) — \`Ax = b\` đã quen mặt.
