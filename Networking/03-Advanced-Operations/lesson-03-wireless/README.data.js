...
// Source: Networking/03-Advanced-Operations/lesson-03-wireless/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 03 — Mạng không dây (Wireless / WiFi)
...
💡 **Vì sao 2.4 GHz xuyên tường tốt hơn?** Tần số thấp hơn → bước sóng dài hơn (λ = c/f: 2.4 GHz → λ ≈ 12.5 cm; 5 GHz → λ ≈ 6 cm). Sóng bước sóng dài "uốn" qua vật cản và hấp thụ ít năng lượng hơn khi đi qua tường gạch. Đây là nguyên lý vật lý từ [Lesson 08 Vật lý — Sóng điện từ](../../../../Physics/02-Thermo-Electromagnetism/lesson-08-em-waves/).
