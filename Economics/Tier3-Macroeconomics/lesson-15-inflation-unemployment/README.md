# Lesson 15 — Inflation & Unemployment
...
| Loại | Mức | Tác động |
|------|-----|----------|
| Lạm phát thấp | $<3\%$ | Lành mạnh, NHTW thường target $\approx 2\%$ |
| Lạm phát trung bình | $3\text{-}10\%$ | Gây bất ổn, cần can thiệp |
| Lạm phát cao | $10\text{-}50\%$ | Đầu tư giảm mạnh, đồng nội tệ mất uy tín |
...
$$\text{Tỉ lệ thất nghiệp} = \frac{\text{Số người thất nghiệp}}{\text{Lực lượng lao động}}$$
...
**Tỉ lệ thất nghiệp tự nhiên (natural rate)** $u_n$ = ma sát + cấu trúc. Thường $4\text{-}5\%$ ở các nước phát triển. **NAIRU** (Non-Accelerating Inflation Rate of Unemployment) = mức thất nghiệp tương thích với lạm phát ổn định.

## 3. Phillips Curve

### 3.1. Quan sát ban đầu (Phillips 1958)

Dữ liệu Anh 1861-1957: lạm phát cao ↔ thất nghiệp thấp. Đường cong dốc xuống trên hệ $(\text{unemployment}, \text{inflation})$.

→ Có *trade-off*? Có thể chọn ít thất nghiệp đổi lấy lạm phát cao?

### 3.2. Đường Phillips ngắn hạn (SRPC)

$$\pi = \pi^e - \beta \cdot (u - u^*)$$
- $\pi^e$ = lạm phát kỳ vọng.
- $u^*$ = NAIRU.
- $\beta > 0$.

Khi $u < u^*$ (nóng) → $\pi > \pi^e$. Khi $u > u^*$ (lạnh) → $\pi < \pi^e$.

### 3.3. Đường Phillips dài hạn (LRPC)

Trong dài hạn, kỳ vọng *điều chỉnh*. Người dân học được lạm phát thực sẽ là gì. → $\pi^e = \pi$. Thay vào SRPC:
$$\pi = \pi - \beta(u - u^*) \implies u = u^*$$
...
CPI: 100 (2020), 110 (2023), 115 (2024). Tính $\pi$ 2023, $\pi$ 2024.
...
$\pi = \pi^e - 0.5(u - 5)$. Cho $\pi^e = 2\%$.

- (a) Nếu $u = 3\%$, $\pi = ?$
- (b) Nếu $u = 7\%$, $\pi = ?$
- (c) Nếu NHTW muốn $\pi = 1\%$, $u$ cần là?
...
$\pi$ 2023 $= \frac{110 - 100}{100} = 10\%$. $\pi$ 2024 $= \frac{115 - 110}{110} \approx 4.55\%$.

### Lời giải Bài 2

Lực lượng lao động $= 10 + 1 = 11$ triệu. $u = \frac{1}{11} \approx 9.1\%$.

### Lời giải Bài 3

(a) $\pi = 2 - 0.5(3 - 5) = 2 + 1 = 3\%$.
(b) $\pi = 2 - 0.5(7 - 5) = 2 - 1 = 1\%$.
(c) $1 = 2 - 0.5(u - 5) \implies 0.5(u - 5) = 1 \implies u = 7\%$. Cần $u$ tăng 2 điểm trên NAIRU để hạ lạm phát 1 điểm. Đây là *sacrifice ratio*.

### Lời giải Bài 4

(a) **Sốc dầu**: SRPC dịch *lên + phải* — tại mỗi mức $u$, lạm phát cao hơn. Stagflation: $u$ tăng + $\pi$ tăng.
