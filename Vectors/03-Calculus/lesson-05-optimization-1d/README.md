# Lesson 05 — Cực trị 1 biến (Optimization 1D)
...
- Biết vì sao trong neural network không giải $\nabla f = 0$ trực tiếp mà phải dùng iterative method (gradient descent — Lesson 07).
...
- Điểm $x = a$ là **cực đại địa phương** nếu tồn tại khoảng mở $(a - \delta, a + \delta)$ sao cho $f(a) \geq f(x)$ với mọi $x$ trong khoảng đó.
- Điểm $x = a$ là **cực tiểu địa phương** nếu tồn tại khoảng mở $(a - \delta, a + \delta)$ sao cho $f(a) \leq f(x)$ với mọi $x$ trong khoảng đó.

**Cực trị toàn cục (global / absolute extremum)** — so sánh trên toàn miền:

- $x = a$ là **cực đại toàn cục** trên miền D nếu $f(a) \geq f(x)$ với mọi $x \in D$.
- $x = a$ là **cực tiểu toàn cục** nếu $f(a) \leq f(x)$ với mọi $x \in D$.
...
> - *"Nếu cả $f'(a) = 0$ thì a chắc chắn là cực trị?"* — KHÔNG. Phản ví dụ: $f(x) = x^3$ tại $x=0$ có $f'(0) = 0$ nhưng không phải cực trị (hàm vẫn tăng đều, slope = 0 chỉ là một khoảnh khắc nằm ngang rồi tiếp tục đi lên). Xem mục 3.
...
**Tử số $f(a + h) - f(a)$**: vì $a$ là cực đại địa phương, với $h$ đủ nhỏ ta có $f(a + h) \leq f(a)$, nên tử số $\leq 0$.

**Giới hạn từ phải** ($h \to 0^+$, tức là $h > 0$):

$$\begin{aligned}
f'(a) &= \lim_{h \to 0^+} \frac{f(a + h) - f(a)}{h} \\[4pt]
      &= \lim \frac{\text{số} \leq 0}{\text{số} > 0} \\[4pt]
      &\leq 0
\end{aligned}$$

**Giới hạn từ trái** ($h \to 0^-$, tức là $h < 0$):
...
Hai giới hạn phải bằng nhau (vì $f'$ tồn tại), nên đồng thời $f'(a) \leq 0$ và $f'(a) \geq 0$. Suy ra $f'(a) = 0$. ∎
...
**Phản ví dụ kinh điển:** $f(x) = x^3$ tại $a = 0$.

- $f'(x) = 3x^2$, do đó $f'(0) = 0$.
- Nhưng tại 0, hàm vẫn đang tăng: với $x > 0$ thì $x^3 > 0$, với $x < 0$ thì $x^3 < 0$. Không có cực trị tại đó — chỉ có điểm yên ngựa (saddle), nơi tiếp tuyến nằm ngang giây lát rồi đi tiếp.
...
**Ví dụ 3.1.** $f(x) = x^2 - 6x + 10$.
- $f'(x) = 2x - 6 = 0 \implies x = 3$. → Critical point: $x = 3$.
- Kiểm tra: parabol mở lên (hệ số $x^2 > 0$) → cực tiểu tại $x = 3$. $f(3) = 9 - 18 + 10 = 1$.

**Ví dụ 3.2.** $f(x) = x^3$.
- $f'(x) = 3x^2 = 0 \implies x = 0$. → Critical point: $x = 0$.
...
**Ví dụ 3.4.** $f(x) = x^{2/3}$.
- $f'(x) = \frac{2}{3} x^{-1/3}$. Tại $x = 0$: $f'(0)$ không tồn tại (chia cho 0 — tiếp tuyến thẳng đứng).
...
**Áp dụng cho $f(x) = x^3$** (đã nói tại mục 2.2):
- $f'(x) = 3x^2$. Trước 0: $f'(-0.1) = 0.03 > 0$. Sau 0: $f'(0.1) = 0.03 > 0$. Dấu không đổi → không phải cực trị. ✓
...
$$\begin{aligned}
f(c + h) &\approx f(c) + f'(c) \cdot h + \tfrac{1}{2} \cdot f''(c) \cdot h^2 \\[4pt]
         &= f(c) + \tfrac{1}{2} \cdot f''(c) \cdot h^2
\end{aligned}$$

- Nếu $f''(c) > 0$: $\tfrac{1}{2} \cdot f''(c) \cdot h^2 > 0$ với mọi $h \neq 0$ nhỏ → $f(c + h) > f(c)$ → c là cực tiểu.
...
- $f(x) = x^4$: $f'(x) = 4x^3 = 0 \implies x = 0$, $f''(x) = 12x^2$, $f''(0) = 0$. Second test bí. Nhưng dùng first derivative test: trước 0, $f'$ âm; sau 0, $f'$ dương → cực tiểu (đúng — đáy của đường cong $x^4$).
- $f(x) = x^3$: $f'(0) = 0$, $f''(0) = 0$. Đây không phải cực trị (đã chứng minh).
...
### 5.1 Ví dụ — Parabol bậc 2: $f(x) = x^2 - 4x + 7$
...
$$\begin{aligned}
f''(x) &= 2 \\[4pt]
f''(2) &= 2 > 0 \implies \text{cực tiểu địa phương tại } x = 2
\end{aligned}$$
...
**Kết luận.** Cực tiểu (cũng là toàn cục, vì parabol mở lên trên toàn $\mathbb{R}$) tại $(2, 3)$.
...
### 5.2 Ví dụ — Bậc 3 có 2 critical points: $f(x) = x^3 - 3x + 1$
...
$$\begin{aligned}
f''(x) &= 6x \\[4pt]
f''(-1) &= -6 < 0 \implies \text{cực đại địa phương tại } x = -1 \\[4pt]
f''(1) &= 6 > 0 \implies \text{cực tiểu địa phương tại } x = 1
\end{aligned}$$

**Bước 4 — Giá trị.**

$$\begin{aligned}
f(-1) &= (-1) - 3(-1) + 1 = -1 + 3 + 1 = 3 \\[4pt]
f(1) &= 1 - 3 + 1 = -1
\end{aligned}$$

**Kết luận.** Cực đại địa phương $(-1, 3)$; cực tiểu địa phương $(1, -1)$. Trên toàn $\mathbb{R}$, hàm bậc 3 có $\lim_{x \to +\infty} f = +\infty$ và $\lim_{x \to -\infty} f = -\infty$, nên không có cực trị toàn cục.

### 5.3 Ví dụ — Có hàm mũ: $f(x) = x \cdot e^{-x}$

**Bước 1 — Tính $f'$ bằng quy tắc tích.**

$$\begin{aligned}
f'(x) &= 1 \cdot e^{-x} + x \cdot (-e^{-x}) \\[4pt]
      &= e^{-x} - x \cdot e^{-x} \\[4pt]
      &= e^{-x} \cdot (1 - x)
\end{aligned}$$
...
$$\begin{aligned}
f''(x) &= \frac{d}{dx} \left[ e^{-x} - x \cdot e^{-x} \right] \\[4pt]
       &= -e^{-x} - \left[ e^{-x} + x \cdot (-e^{-x}) \right] \\[4pt]
       &= -e^{-x} - e^{-x} + x \cdot e^{-x} \\[4pt]
       &= e^{-x} \cdot (x - 2)
\end{aligned}$$

**Bước 4 — Phân loại.**

$$f''(1) = e^{-1} \cdot (1 - 2) = -\frac{1}{e} \approx -0.368 < 0 \implies \text{cực đại tại } x = 1$$

**Bước 5 — Giá trị.**

$$f(1) = 1 \cdot e^{-1} = \frac{1}{e} \approx 0.368$$

**Kết luận.** Cực đại địa phương tại $(1, 1/e)$. Đây cũng là cực đại toàn cục trên $\mathbb{R}^+$ (kiểm tra: $\lim_{x \to \infty} x \cdot e^{-x} = 0$, $f(0) = 0$).
...
### 5.4 Ví dụ — Bậc 4: $f(x) = x^4 - 2x^2$ (2 min + 1 max)
...
$$\begin{aligned}
f''(-1) &= 12 - 4 = 8 > 0 \implies \text{cực tiểu tại } x = -1 \\[4pt]
f''(0) &= -4 < 0 \implies \text{cực đại tại } x = 0 \\[4pt]
f''(1) &= 12 - 4 = 8 > 0 \implies \text{cực tiểu tại } x = 1
\end{aligned}$$
...
> 💡 **Trực giác.** Hàm bậc 4 dạng $x^4 - 2x^2$ mô tả **hệ có 2 trạng thái bền** — như nam châm có 2 hướng phân cực, hay nucleotide trong DNA có 2 cấu hình. Cực đại ở giữa là rào năng lượng phải vượt qua.

> ❓ **Câu hỏi tự nhiên.** *"Sao hàm $f(x) = x^4 - 2x^2$ có max ở giữa cao bằng 0, nhưng 2 min bên hai bên cùng $= -1$? Hai min cùng giá trị có ý nghĩa gì?"* — Vì f là hàm **chẵn**: $f(-x) = f(x)$. Đối xứng qua trục y nên giá trị tại $x$ và $-x$ giống hệt. Đây là biểu hiện của **đối xứng** — một khái niệm quan trọng trong vật lý và ML.

> 🔁 **Dừng lại tự kiểm tra.** Cho $f(x) = x^4 - 4x$. Tìm tất cả cực trị địa phương và phân loại.
>
> <details><summary>Đáp án</summary>
>
> $f'(x) = 4x^3 - 4 = 0 \implies x^3 = 1 \implies x = 1$ (chỉ 1 nghiệm thực, vì $x^3 = 1 \iff x = 1$; còn hai nghiệm phức bỏ qua).
>
> $f''(x) = 12x^2$. $f''(1) = 12 > 0$ → cực tiểu địa phương tại $x = 1$.
>
> $f(1) = 1 - 4 = -3$. Cực tiểu duy nhất $(1, -3)$. Đây cũng là cực tiểu toàn cục vì $\lim_{x \to \pm\infty} f = +\infty$.
>
> </details>
...
### 6.1 Walk-through: tìm max/min của $f(x) = x^2 - 2x$ trên $[0, 3]$
...
### 6.2 Walk-through thứ hai: $f(x) = x^3 - 3x$ trên $[-2, 2]$

**Bước 1.** $f'(x) = 3x^2 - 3$.

**Bước 2.** Critical points: $3x^2 - 3 = 0 \implies x = \pm 1$. Cả hai đều thuộc $(-2, 2)$.
...
| Ví dụ | $x^2$: $x = 0$ (cực tiểu) | $x^3$: $x = 0$ (inflection) |

Hai khái niệm **độc lập** — một điểm có thể vừa là cả hai (như $x^3$ tại 0), vừa là cực trị mà không phải inflection, vừa là inflection mà không phải cực trị.
...
Cho 3 điểm dữ liệu: $(x_1, y_1) = (1, 2)$, $(x_2, y_2) = (2, 3.5)$, $(x_3, y_3) = (3, 5.5)$.

Ta muốn tìm đường thẳng $y = a \cdot x$ (qua gốc tọa độ, không có bias) **gần đúng nhất** với 3 điểm này.

**Câu hỏi:** chọn $a$ bằng bao nhiêu cho "tốt nhất"?

### 8.2 Hàm loss MSE (Mean Squared Error)

"Tốt nhất" được định nghĩa qua **loss function**: tổng bình phương sai số giữa dự đoán $a \cdot x_i$ và giá trị thật $y_i$.

$$\begin{aligned}
L(a) &= \sum_i (y_i - a \cdot x_i)^2 \\[4pt]
     &= (y_1 - a \cdot x_1)^2 + (y_2 - a \cdot x_2)^2 + (y_3 - a \cdot x_3)^2
\end{aligned}$$

Thay số:

$$\begin{aligned}
L(a) &= (2 - a \cdot 1)^2 + (3.5 - a \cdot 2)^2 + (5.5 - a \cdot 3)^2 \\[4pt]
     &= (2 - a)^2 + (3.5 - 2a)^2 + (5.5 - 3a)^2
\end{aligned}$$

$L(a)$ là một **hàm bậc 2** theo a (parabol mở lên — vì hệ số $a^2$ dương).

### 8.3 Khai triển L(a)

$$\begin{aligned}
(2 - a)^2 &= a^2 - 4a + 4 \\[4pt]
(3.5 - 2a)^2 &= 4a^2 - 14a + 12.25 \\[4pt]
(5.5 - 3a)^2 &= 9a^2 - 33a + 30.25 \\[4pt]
\hline
L(a) &= 14a^2 - 51a + 46.5
\end{aligned}$$
...
$$28a - 51 = 0 \implies a^* = \frac{51}{28} \approx 1.8214$$

Verify đây là cực tiểu:

$$L''(a) = 28 > 0 \implies \text{parabol mở lên} \implies a^* \text{ là cực tiểu toàn cục}$$

### 8.5 Verify bằng công thức tổng quát

Công thức closed-form cho regression qua gốc tọa độ:

$$a^* = \frac{\sum x_i \cdot y_i}{\sum x_i^2}$$

Tính trực tiếp:

$$\begin{aligned}
\sum x_i \cdot y_i &= 1 \cdot 2 + 2 \cdot 3.5 + 3 \cdot 5.5 = 2 + 7 + 16.5 = 25.5 \\[4pt]
\sum x_i^2 &= 1 + 4 + 9 = 14 \\[4pt]
a^* &= \frac{25.5}{14} = \frac{51}{28} \approx 1.8214 \quad ✓
\end{aligned}$$
...
$$\begin{aligned}
L(1.8214) &= 14 \cdot (1.8214)^2 - 51 \cdot (1.8214) + 46.5 \\[4pt]
          &= 14 \cdot 3.3175 - 92.8929 + 46.5 \\[4pt]
          &= 46.4444 - 92.8929 + 46.5 \\[4pt]
          &\approx 0.0515
\end{aligned}$$

Tổng bình phương sai số nhỏ nhất $\approx 0.0515$. Tức là đường thẳng $y = 1.8214x$ cách 3 điểm rất gần.

### 8.7 Tổng quát hóa cho n điểm

Với n điểm dữ liệu $(x_i, y_i)$, loss MSE và nghiệm tối ưu:

$$\begin{aligned}
L(a) &= \sum_i (y_i - a \cdot x_i)^2 \\[4pt]
L'(a) &= -2 \sum_i x_i (y_i - a \cdot x_i) = 0 \\[4pt]
      &\implies \sum_i x_i \cdot y_i = a \cdot \sum_i x_i^2 \\[4pt]
      &\implies a^* = \frac{\sum x_i \cdot y_i}{\sum x_i^2}
\end{aligned}$$

Đây là phiên bản **đơn giản nhất** của linear regression: 1 chiều, không bias. Phiên bản đầy đủ $y = a \cdot x + b$ cần đạo hàm theo 2 biến a, b — đó là **đạo hàm riêng** (Lesson 06). Trường hợp đa chiều cần linear algebra (Tầng 4).
...
1. **Số tham số quá lớn.** Neural network có hàng triệu tới hàng tỷ tham số. Hệ phương trình $\nabla L = 0$ gồm hàng triệu phương trình bậc cao — không thể giải đóng được.
2. **Phi tuyến nặng.** Loss của NN chứa các thành phần phi tuyến (ReLU, sigmoid, tanh, attention...) khiến $\nabla L = 0$ không có công thức giải.
3. **Loss landscape lồi lõm.** L có hàng triệu critical points (min, max, saddle). Tìm $\nabla L = 0$ chỉ là điều kiện cần — phân loại từng cái sẽ rất tốn.
4. **Bộ nhớ.** Tính ma trận Hessian (đạo hàm bậc 2) tốn $O(n^2)$ bộ nhớ — không khả thi với $n = $ triệu.

**Giải pháp**: **iterative method** — bắt đầu từ một điểm ngẫu nhiên, đi từng bước nhỏ theo hướng $-\nabla L$ (giảm loss nhanh nhất), lặp đến khi gần điểm cực tiểu. Đó chính là **gradient descent** (Lesson 07).
...
| Bộ nhớ | Cần ma trận $n \times n$ | Chỉ cần gradient n |
...
> 4. **Nhầm critical point với cực trị** — $f(x) = x^3$ có $f'(0) = 0$ nhưng không phải cực trị.
> 5. **$f''(c) = 0$ rồi kết luận luôn** — không kết luận được, phải dùng first derivative test.
> 6. **Nhầm cực đại địa phương với cực đại toàn cục** — trên $\mathbb{R}$ không bị chặn, cực trị địa phương có thể không phải toàn cục.
> 7. **Bỏ qua dấu của hệ số bậc cao** — bậc 3 mở từ $-\infty$ tới $+\infty$, không có cực trị toàn cục trên $\mathbb{R}$.
...
### Bài 11.1
Tìm và phân loại tất cả cực trị địa phương của $f(x) = 2x^3 - 9x^2 + 12x - 3$.

### Bài 11.2
Tìm cực trị toàn cục của $f(x) = x^3 - 3x^2 + 2$ trên đoạn $[0, 3]$.

### Bài 11.3
Cho hàm $f(x) = x \cdot \ln(x)$ trên $(0, \infty)$. Tìm cực tiểu và chứng minh đó là cực tiểu toàn cục.

### Bài 11.4
Cho 3 điểm dữ liệu: $(1, 1), (2, 3), (3, 4)$. Tìm $a^*$ tối ưu cho mô hình $y = a \cdot x$.

### Bài 11.5
Tìm tất cả inflection points của $f(x) = x^4 - 6x^2 + 5$.
...
**Bước 1.** $f'(x) = 6x^2 - 18x + 12 = 6(x^2 - 3x + 2) = 6(x - 1)(x - 2)$.

**Bước 2.** $f'(x) = 0 \implies x = 1$ hoặc $x = 2$.

**Bước 3.** $f''(x) = 12x - 18$.
- $f''(1) = 12 - 18 = -6 < 0 \implies$ cực đại tại $x = 1$.
- $f''(2) = 24 - 18 = 6 > 0 \implies$ cực tiểu tại $x = 2$.

**Bước 4.** Giá trị:
- $f(1) = 2 - 9 + 12 - 3 = 2$.
- $f(2) = 16 - 36 + 24 - 3 = 1$.

**Kết luận.** Cực đại địa phương $(1, 2)$; cực tiểu địa phương $(2, 1)$. Không có cực trị toàn cục trên $\mathbb{R}$.

### Lời giải 11.2

$f(x) = x^3 - 3x^2 + 2$ trên $[0, 3]$.
...
$f(x) = x \cdot \ln(x)$ trên $(0, \infty)$.

**Bước 1.** $f'(x) = \ln(x) + x \cdot \frac{1}{x} = \ln(x) + 1$.

**Bước 2.** $f'(x) = 0 \iff \ln(x) = -1 \iff x = e^{-1} = \frac{1}{e} \approx 0.368$.

**Bước 3.** $f''(x) = \frac{1}{x} > 0$ với mọi $x > 0$. Đặc biệt $f''(1/e) = e > 0$ → cực tiểu địa phương.

**Bước 4.** Giá trị: $f(1/e) = \frac{1}{e} \cdot \ln(1/e) = \frac{1}{e} \cdot (-1) = -\frac{1}{e} \approx -0.368$.

**Toàn cục.** Vì $f''(x) > 0$ trên toàn miền $(0, \infty)$, hàm **lồi nghiêm ngặt (strictly convex)**. Với hàm lồi, cực tiểu địa phương = cực tiểu toàn cục. Vậy $(1/e, -1/e)$ là cực tiểu toàn cục.

### Lời giải 11.4

3 điểm $(1, 1), (2, 3), (3, 4)$. Mô hình $y = a \cdot x$.

**Cách 1 — Đạo hàm.**

$$\begin{aligned}
L(a) &= (1 - a)^2 + (3 - 2a)^2 + (4 - 3a)^2 \\[4pt]
     &= (a^2 - 2a + 1) + (4a^2 - 12a + 9) + (9a^2 - 24a + 16) \\[4pt]
     &= 14a^2 - 38a + 26 \\[4pt]
L'(a) &= 28a - 38 = 0 \implies a^* = \frac{38}{28} = \frac{19}{14} \approx 1.3571 \\[4pt]
L''(a) &= 28 > 0 \implies \text{cực tiểu (đúng)}
\end{aligned}$$

**Cách 2 — Công thức closed-form.**

$$\begin{aligned}
\sum xy &= 1 \cdot 1 + 2 \cdot 3 + 3 \cdot 4 = 1 + 6 + 12 = 19 \\[4pt]
\sum x^2 &= 1 + 4 + 9 = 14 \\[4pt]
a^* &= \frac{19}{14} \approx 1.3571 \quad ✓
\end{aligned}$$

**Loss tối thiểu.**

$$\begin{aligned}
L(19/14) &= 14 \cdot \left(\frac{19}{14}\right)^2 - 38 \cdot \frac{19}{14} + 26 \\[4pt]
         &= \frac{19^2}{14} - \frac{38 \cdot 19}{14} + 26 \\[4pt]
         &= \frac{361}{14} - \frac{722}{14} + \frac{364}{14} \\[4pt]
...
**Bước 1.** $f'(x) = 4x^3 - 12x = 4x(x^2 - 3)$.

**Bước 2.** $f''(x) = 12x^2 - 12 = 12(x^2 - 1) = 12(x - 1)(x + 1)$.

**Bước 3.** $f''(x) = 0 \iff x = \pm 1$.

**Bước 4.** Xét dấu $f''$:
- $x < -1$: $(-2)^2 - 1 = 3 > 0$ → $f'' > 0$ → lồi.
- $-1 < x < 1$: $(0)^2 - 1 = -1 < 0$ → $f'' < 0$ → lõm.
- $x > 1$: $(2)^2 - 1 = 3 > 0$ → $f'' > 0$ → lồi.
...
Tổng rào: $x + 2y = 100 \implies x = 100 - 2y$.

Diện tích: $A(y) = x \cdot y = (100 - 2y) \cdot y = 100y - 2y^2$.

Miền hợp lệ: $y > 0$ và $x = 100 - 2y > 0 \iff y < 50$. Vậy $y \in (0, 50)$.

**Tìm cực đại.**

$$\begin{aligned}
A'(y) &= 100 - 4y = 0 \implies y^* = 25 \\[4pt]
A''(y) &= -4 < 0 \implies \text{cực đại tại } y = 25
\end{aligned}$$

Khi $y = 25$: $x = 100 - 50 = 50$.

**Diện tích cực đại.** $A^* = 50 \cdot 25 = 1250 \text{ m}^2$.

**Kiểm tra biên.** $y \to 0$ hoặc $y \to 50$: $A \to 0$. Không cạnh tranh với cực đại 1250.
...
> 📝 **Tóm tắt Lesson 05.**
> 1. **Điều kiện cần (Fermat)**: cực trị địa phương + khả vi $\implies f'(x) = 0$.
...
> 5. **Linear regression 1 tham số**: $a^* = \dfrac{\sum x_i y_i}{\sum x_i^2}$ — giải đóng bằng $L'(a) = 0$.
