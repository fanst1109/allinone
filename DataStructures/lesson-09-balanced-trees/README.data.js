...
// Source: DataStructures/lesson-09-balanced-trees/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 09 — Balanced Trees (AVL, Red-Black)
...
### 7.2. Rotate right — phân rã 5 bước
...
### 7.3. Bốn case với ví dụ số cụ thể
...
### 7.4. Làm sao biết quay chiều nào? — Bảng quyết định
...
### 7.5. Walk-through trọn vẹn — Insert 7 giá trị vào AVL trống
...
### 7.7. ⚠ Lỗi thường gặp khi cài rotation
