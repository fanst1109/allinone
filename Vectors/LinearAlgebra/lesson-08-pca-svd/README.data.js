...
// Source: Vectors/LinearAlgebra/lesson-08-pca-svd/README.md
...
- [Tầng 3 — Calculus, Lesson 06 — Đạo hàm riêng + gradient](../../Calculus/lesson-06-partial-gradient/): khi chứng minh PCA tối đa hóa phương sai, bạn cần ∇ Lagrangian = 0. Đoạn chứng minh ở mục 4 sẽ dùng tới.
...
Tính \`∂L/∂w\` (xem [Tầng 3 — Calculus, Lesson 06](../../Calculus/lesson-06-partial-gradient/) để nhớ cách derive theo vector):
...
**Train**: minimize \`Σ_{(u,m) đã rate} (R[u][m] − U_k[u]·V_k[m])²\` bằng gradient descent (xem [Calculus L7](../../Calculus/lesson-07-gradient-descent/)) hoặc Alternating Least Squares.
...
- **MLE (Maximum Likelihood Estimation)** dùng gradient descent đã học ở [Calculus L7](../../Calculus/lesson-07-gradient-descent/).
