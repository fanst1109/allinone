...
// Source: Vectors/LinearAlgebra/lesson-07-eigenvectors/README.md
...
- [Algebra Lesson 06](../../Algebra/lesson-06-linear-quadratic/) — nghiệm phương trình bậc 2 (dùng để giải đặc trưng).
- [Algebra Lesson 08](../../Algebra/lesson-08-linear-systems/) — giải hệ phương trình tuyến tính bằng khử Gauss (dùng để tìm eigenvector).
...
- **Tham khảo chéo**:
  - [Algebra Lesson 06](../../Algebra/lesson-06-linear-quadratic/) — nghiệm phương trình bậc 2.
  - [Algebra Lesson 08](../../Algebra/lesson-08-linear-systems/) — khử Gauss.
  - [Trigonometry Lesson 06](../../Trigonometry/lesson-06-rotation-matrix/) — ma trận xoay (ví dụ eigenvalue phức).
- **Tham khảo bên ngoài**:
