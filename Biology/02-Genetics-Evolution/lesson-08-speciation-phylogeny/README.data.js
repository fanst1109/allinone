...
// Source: Biology/02-Genetics-Evolution/lesson-08-speciation-phylogeny/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 08 — Hình thành loài & phát sinh
...
> **% khác biệt DNA giữa 2 loài ≈ 2 × tốc độ đột biến × thời gian phân kỳ**
...
- μ = tốc độ đột biến trên mỗi base mỗi năm

### 4.4. Bốn ví dụ số cụ thể

**Ví dụ 1 — Người và tinh tinh:**
DNA khác ~1.2% = D = 0.012. Tốc độ đột biến trung tính μ ≈ 10⁻⁹ thay đổi/base/năm (giả định).
t = 0.012 / (2 × 10⁻⁹) = 0.012 / (2 × 10⁻⁹) = 6 × 10⁶ = **6 triệu năm**. Khớp với hóa thạch (5–7 triệu năm trước).

**Ví dụ 2 — Người và chuột:**
Khác ~15% DNA, D = 0.15. Cùng μ = 10⁻⁹.
t = 0.15 / (2 × 10⁻⁹) = 7.5 × 10⁷ = **75 triệu năm**. Khớp với phân kỳ giữa động vật có vú nguyên thủy trong kỷ Phấn Trắng.

**Ví dụ 3 — Hai loài chim sẻ Darwin:**
D = 0.003 (rất gần). μ = 10⁻⁹.
t = 0.003 / (2 × 10⁻⁹) = 1.5 × 10⁶ = **1.5 triệu năm** — phù hợp lịch sử Galápagos.
...
1. Hai loài có DNA khác 2.4%. μ = 10⁻⁹. Thời gian phân kỳ là bao nhiêu?
2. Trong cây ((A,B),(C,(D,E))), MRCA của D và E là ai? MRCA của A và E? Nhóm {C, D, E} có phải clade không?

<details>
<summary>Đáp án</summary>

1. t = 0.024 / (2 × 10⁻⁹) = 1.2 × 10⁷ = **12 triệu năm**.
...
- Đồng hồ phân tử: t = D / (2 × μ). Có sai số, cần hiệu chuẩn với hóa thạch.
...
**Bài 4**: Hai loài có DNA khác nhau 4.8%. Tốc độ đột biến trung tính μ = 1.2 × 10⁻⁹ thay đổi/base/năm.
...
**Bài 4**:
(a) D = 0.048, μ = 1.2 × 10⁻⁹.
t = D / (2 × μ) = 0.048 / (2 × 1.2 × 10⁻⁹) = 0.048 / (2.4 × 10⁻⁹) = 2 × 10⁷ = **20 triệu năm**.
(b) Với μ = 2 × 10⁻⁹: t = 0.048 / (4 × 10⁻⁹) = 1.2 × 10⁷ = **12 triệu năm**.
...
6. **Đồng hồ phân tử**: t = D / (2 × μ). Người-tinh tinh ~1.2% DNA → ~6 triệu năm trước. Có sai số, cần hiệu chuẩn với hóa thạch.
