# Lesson 03 — Biểu đồ Hertzsprung–Russell (H-R Diagram)
...
- Hiểu **quan hệ khối lượng–độ trưng** trên dải chính: $L \propto M^{3{,}5}$.
- Đặt được các sao thật (Mặt Trời, Sirius A, Betelgeuse...) vào đúng vùng.

## Kiến thức tiền đề

- **Bức xạ vật đen, Wien, Stefan–Boltzmann** — [Lesson 01](../lesson-01-radiation-spectra/): màu ↔ nhiệt độ, $L = 4\pi R^2 \sigma T^4$.
...
- **(b) Vì sao tồn tại / cần** — Vạch hấp thụ nào xuất hiện phụ thuộc nhiệt độ (quá nóng thì hydro bị ion hóa hết → vạch H yếu; quá lạnh thì hiện vạch phân tử). Phân loại phổ là cách *đo nhiệt độ* mà không cần đo trực tiếp $\lambda_{max}$, và là trục ngang của biểu đồ H-R.
...
- **Trục đứng**: độ trưng L (theo $L/L_\odot$, thang logarit), hoặc cấp tuyệt đối M (số nhỏ = sáng = lên trên).
...
- **(b) Vì sao tồn tại** — Theo $L = 4\pi R^2 \sigma T^4$, một sao lạnh chỉ sáng được nếu **bán kính cực lớn** ($R^2$ bù cho $T^4$ nhỏ). Đó là sao đã rời dải chính, phồng to ở cuối đời (Lesson 05).
...
**Walk-through đặt sao bằng số thật** (dùng $\dfrac{L}{L_\odot} = \left(\dfrac{R}{R_\odot}\right)^2 \left(\dfrac{T}{T_\odot}\right)^4$ từ Lesson 01):

| Sao | Lớp | T (K) | R/R☉ | L/L☉ (tính) | Vùng |
|---|---|---|---|---|---|
| Mặt Trời | G2 | 5778 | 1 | $1^2 \times 1^4 =$ **1** | Dải chính (giữa) |
| Sirius A | A1 | 9940 | 1,71 | $1{,}71^2 \times \left(\frac{9940}{5778}\right)^4 \approx$ **25,6** | Dải chính (trên-trái) |
| Betelgeuse | M2 | 3500 | 900 | $900^2 \times \left(\frac{3500}{5778}\right)^4 \approx$ **$1{,}1 \times 10^5$** | Siêu khổng lồ (trên-phải) |
| Sirius B | DA | 25000 | 0,0084 | $0{,}0084^2 \times \left(\frac{25000}{5778}\right)^4 \approx$ **0,025** | Lùn trắng (dưới-trái) |

Kiểm chứng Betelgeuse: $\left(\dfrac{3500}{5778}\right)^4 = 0{,}6058^4 = 0{,}1347$; $900^2 = 810000$; tích $= 810000 \times 0{,}1347 \approx 1{,}09 \times 10^5$ ✓.
...
> 🔁 **Dừng lại tự kiểm tra.** Một sao rất nóng ($T = 20000 \ \text{K}$) nhưng độ trưng chỉ $0{,}01 \ L_\odot$. Nó nằm ở vùng nào, và bán kính cỡ bao nhiêu?
> <details><summary>Đáp án</summary>Vùng **lùn trắng** (dưới-trái: nóng mà mờ). Bán kính: $0{,}01 = \left(\dfrac{R}{R_\odot}\right)^2 \left(\dfrac{20000}{5778}\right)^4 = \left(\dfrac{R}{R_\odot}\right)^2 \times 143{,}6$ → $\left(\dfrac{R}{R_\odot}\right)^2 = 6{,}96 \times 10^{-5}$ → $\dfrac{R}{R_\odot} \approx 0{,}0083$ (cỡ Trái Đất).</details>
...
- **(a) Là gì** — Với sao dải chính, độ trưng tăng nhanh theo khối lượng: $\dfrac{L}{L_\odot} \approx \left(\dfrac{M}{M_\odot}\right)^{3{,}5}$ (số mũ ~3 đến ~4 tùy dải khối lượng; ta dùng $3{,}5$).
...
- **(c) Ví dụ trực giác bằng số** — Sao $2 \ M_\odot$ sáng $2^{3{,}5} \approx 11{,}3$ lần Mặt Trời; sao $0{,}5 \ M_\odot$ chỉ sáng $0{,}5^{3{,}5} \approx 0{,}088$ lần.

**Walk-through số thật (verify):**

1. **$M = 10 \ M_\odot$:**
   $$\frac{L}{L_\odot} = 10^{3{,}5} = 3162$$
   → sao 10 lần khối lượng sáng hơn ~3000 lần. (Khớp bậc độ lớn cho sao lớp B.)

2. **$M = 0{,}5 \ M_\odot$ (lùn đỏ):**
   $$\frac{L}{L_\odot} = 0{,}5^{3{,}5} = 0{,}088$$
   → chỉ sáng ~9% Mặt Trời. Verify: $0{,}5^{3{,}5} = 2^{-3{,}5} = \dfrac{1}{11{,}3} = 0{,}0884$ ✓.

3. **$M = 1 \ M_\odot$:** $1^{3{,}5} = 1$ → đúng Mặt Trời (mốc chuẩn). ✓

4. **Kiểm tra ngược:** sao có $L = 100 \ L_\odot$. Khối lượng?
   $$\frac{M}{M_\odot} = 100^{1/3{,}5} = 10^{2/3{,}5} = 10^{0{,}571} = 3{,}7$$
   → khoảng $3{,}7 \ M_\odot$.
...
> 🔁 **Dừng lại tự kiểm tra.** Sao $4 \ M_\odot$ sáng gấp mấy lần Mặt Trời (dải chính)?
> <details><summary>Đáp án</summary>$\dfrac{L}{L_\odot} = 4^{3{,}5} = (2^2)^{3{,}5} = 2^7 = 128$ lần.</details>
...
> - **Khối lượng–độ trưng**: $\dfrac{L}{L_\odot} \approx \left(\dfrac{M}{M_\odot}\right)^{3{,}5}$; nặng → sáng vọt → sống ngắn.
...
2. **Đặt sao vào vùng.** Cho 3 sao: (a) $T = 4000 \ \text{K}$, $L = 300 \ L_\odot$; (b) $T = 15000 \ \text{K}$, $L = 0{,}01 \ L_\odot$; (c) $T = 6000 \ \text{K}$, $L = 1 \ L_\odot$. Mỗi sao thuộc vùng nào của H-R? Giải thích bằng $L = 4\pi R^2 \sigma T^4$.

3. **Suy bán kính từ H-R.** Sao (a) ở bài 2 ($T = 4000 \ \text{K}$, $L = 300 \ L_\odot$). Tính $\dfrac{R}{R_\odot}$.

4. **Khối lượng–độ trưng.** Một sao dải chính có $M = 5 \ M_\odot$. Tính độ trưng $\dfrac{L}{L_\odot}$.

5. **Ngược lại.** Một sao dải chính sáng $1000 \ L_\odot$. Ước lượng khối lượng theo $L \propto M^{3{,}5}$.
...
- **(a) $T = 4000 \ \text{K}$, $L = 300 \ L_\odot$**: lạnh mà rất sáng ⇒ phải to ⇒ **khổng lồ đỏ** (trên-phải). (Lớp K/M.)
- **(b) $T = 15000 \ \text{K}$, $L = 0{,}01 \ L_\odot$**: nóng mà rất mờ ⇒ phải tí hon ⇒ **lùn trắng** (dưới-trái).
- **(c) $T = 6000 \ \text{K}$, $L = 1 \ L_\odot$**: gần đúng Mặt Trời ⇒ **dải chính** (lớp G, giữa dải).

Lý do chung: với cùng L, vị trí T quyết định R qua $L = 4\pi R^2 \sigma T^4$. Lạnh+sáng → R lớn; nóng+mờ → R nhỏ.

### Bài 3 — Suy bán kính (sao khổng lồ đỏ)

Dùng $\dfrac{L}{L_\odot} = \left(\dfrac{R}{R_\odot}\right)^2 \left(\dfrac{T}{T_\odot}\right)^4$, giải R:
$$\begin{aligned}
\left(\frac{R}{R_\odot}\right)^2 &= \frac{L/L_\odot}{(T/T_\odot)^4} = \frac{300}{(4000/5778)^4} \\
\left(\frac{4000}{5778}\right)^4 &= 0{,}6923^4 = 0{,}2297 \\
\left(\frac{R}{R_\odot}\right)^2 &= \frac{300}{0{,}2297} = 1306 \\
\frac{R}{R_\odot} &= \sqrt{1306} \approx 36{,}1
\end{aligned}$$
...
$$\begin{aligned}
\frac{L}{L_\odot} &= \left(\frac{M}{M_\odot}\right)^{3{,}5} = 5^{3{,}5} \\
\log &: 3{,}5 \times \log(5) = 3{,}5 \times 0{,}699 = 2{,}447 \\
\frac{L}{L_\odot} &= 10^{2{,}447} \approx 280
\end{aligned}$$
→ sao $5 \ M_\odot$ sáng ~**280 lần** Mặt Trời.

### Bài 5 — Ngược lại

$$\begin{aligned}
\frac{M}{M_\odot} &= \left(\frac{L}{L_\odot}\right)^{1/3{,}5} = 1000^{1/3{,}5} \\
\log &: \frac{1}{3{,}5} \times \log(1000) = \frac{1}{3{,}5} \times 3 = 0{,}857 \\
\frac{M}{M_\odot} &= 10^{0{,}857} \approx 7{,}2
\end{aligned}$$
→ khối lượng ~**7 M☉**. Verify: $7{,}2^{3{,}5} = 10^{3{,}5 \times 0{,}857} = 10^{3{,}0} = 1000$ ✓.
...
→ [Lesson 04 — Vòng đời sao](../lesson-04-star-life/): vì sao sao nằm trên dải chính (cân bằng thủy tĩnh), nhiệt hạch H→He, và vì sao sao nặng sống ngắn ($t \propto \dfrac{M}{L} \propto M^{-2{,}5}$). Ta dùng lại **quan hệ khối lượng–độ trưng** của bài này.
