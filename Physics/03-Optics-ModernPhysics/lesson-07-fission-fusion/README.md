# Lesson 07 (T3) — Phân hạch & Nhiệt hạch
...
- **(a) Là gì**: năng lượng liên kết chia cho tổng số nucleon, `E_lk/A` (MeV/nucleon). Đo mức độ "giữ chặt TRUNG BÌNH mỗi nucleon" — cao hơn = hạt nhân bền hơn.
- **(b) Vì sao cần**: E_lk tổng luôn tăng theo kích thước hạt nhân nên không so sánh độ bền trực tiếp được. Chia cho A mới so được hạt nhân lớn-nhỏ công bằng → giải thích vì sao cả fission lẫn fusion đều "leo dốc về phía Fe".
- **(c) Ví dụ số kèm đơn vị**: H-2 chỉ ~1.1 MeV/nucleon (lỏng lẻo); Fe-56 ~8.8 MeV/nucleon (chặt nhất); U-238 ~7.6 MeV/nucleon. Đi từ U về Fe (fission) hay từ H về Fe (fusion) đều tăng E_lk/nucleon → tỏa năng lượng.
...
- *"Năng lượng tỏa ra từ đâu?"* Từ độ hụt khối: tổng khối lượng sản phẩm < tổng khối lượng ban đầu, phần chênh `Δm·c²` thành năng lượng.

⚠ **Lỗi thường gặp**

- **Tưởng hạt nhân càng nặng càng bền.** Sai — bền nhất là Fe-56 ở GIỮA. U-238 nặng nhưng kém bền hơn Fe (dễ phân hạch).
- **Lẫn E_lk tổng với E_lk/nucleon.** U-238 có E_lk tổng lớn (nhiều nucleon) nhưng E_lk/nucleon lại THẤP hơn Fe → so độ bền phải dùng giá trị trên mỗi nucleon.

🔁 **Dừng lại tự kiểm tra**

1. Đồng vị nào bền nhất, ở đâu trên đồ thị E_lk/nucleon?
2. Ghép 2 hạt H-2 thành He-4 tỏa hay thu năng lượng? Vì sao?

<details><summary>Đáp án</summary>

1. **Fe-56**, ở ĐỈNH đồ thị (~8.8 MeV/nucleon) — nucleon được giữ chặt nhất.
2. **Tỏa** năng lượng. He-4 (~7 MeV/nucleon) bền hơn H-2 (~1.1 MeV/nucleon) → tiến gần Fe → tăng E_lk/nucleon → nhả năng lượng ra.

</details>

### 📝 Tóm tắt mục 1

- E_lk/nucleon = "độ bền trung bình mỗi nucleon", đỉnh ở Fe-56 (~8.8 MeV).
- Hạt nhẹ ghép lại (fusion) và hạt nặng tách ra (fission) đều tiến về Fe → đều tỏa năng lượng.
- Năng lượng đến từ độ hụt khối `Δm·c²`.
...
- *"Thanh điều khiển và chất giảm tốc khác nhau thế nào?"* Thanh điều khiển (Cd, B) HẤP THỤ neutron dư → giảm tốc độ phản ứng. Chất giảm tốc (H₂O, D₂O) LÀM CHẬM neutron (không hấp thụ) → neutron chậm dễ gây fission hơn.
- *"200 MeV mỗi phản ứng có lớn không?"* Cực lớn so với hóa học — phản ứng đốt cháy chỉ vài eV/phân tử. `200 MeV / vài eV ≈ 40 triệu lần` → vì sao 1 kg U thay được hàng triệu kg than.
...
1. Cân bằng: ²³⁵U + n → ¹⁴¹Ba + ⁹²Kr + ? n. Bao nhiêu neutron sinh ra?
2. Trong lò, để giảm tốc độ phản ứng nên đẩy thanh điều khiển VÀO hay RÚT RA?

<details><summary>Đáp án</summary>

1. Bảo toàn số khối: `235 + 1 = 141 + 92 + x → 236 = 233 + x → x = 3` neutron. (Bảo toàn Z: 92 = 56 + 36 ✓.)
...
- *"Mặt Trời nóng 'chỉ' ~15 triệu °C ở lõi sao vẫn fusion được?"* Nhờ áp suất hấp dẫn khổng lồ + hiệu ứng đường hầm lượng tử + thời gian khổng lồ. Trên Trái Đất thiếu áp suất đó nên phải bù bằng nhiệt độ cao hơn.
...
1. Phản ứng `²H + ³H → ⁴He + ?` — hạt còn thiếu là gì? (Bảo toàn số khối và số hiệu.)
2. Mặt Trời tỏa năng lượng nhờ fission hay fusion?

<details><summary>Đáp án</summary>

1. Bảo toàn A: `2+3 = 4 + x → x có A = 1`. Bảo toàn Z: `1+1 = 2 + y → y có Z = 0`. → hạt A=1, Z=0 = **neutron (n)**. Đầy đủ: `²H + ³H → ⁴He + n + 17.6 MeV`.
