...
// Source: SoftwareEngineering/01-Foundations/lesson-06-estimation-planning/README.md
...
> 💡 **Vì sao "ước lượng" lại là một kỹ năng kỹ thuật, không phải việc của riêng quản lý?** Vì người *làm* việc mới biết việc đó khó tới đâu. Ước lượng tồi → cam kết tồi → đội làm overtime, cắt test, chất lượng tụt (nối thẳng đường cong chi phí ở [Lesson 01](../lesson-01-sdlc-engineer-role/)). Một kỹ sư biết ước lượng *trung thực và có phương pháp* bảo vệ được cả tiến độ lẫn chất lượng.
...
> - *"Nếu mãi không hội tụ?"* — Thường là dấu hiệu story chưa đủ rõ hoặc quá to → tách nhỏ hoặc làm rõ yêu cầu trước ([Lesson 03](../lesson-03-requirements-spec/)).
...
Khi trễ, cám dỗ lớn nhất là "tạm bỏ test cho kịp". Nhưng cắt test không *xóa* việc — nó **đẩy lỗi về sau**, đúng [đường cong chi phí Lesson 01](../lesson-01-sdlc-engineer-role/): lỗi bắt ở production đắt gấp hàng chục lần bắt sớm.
...
|--------|--------|----------------------------|
| [01](../lesson-01-sdlc-engineer-role/) | SDLC & vai trò kỹ sư | Làm phần mềm *thật* khác viết code thế nào? |
| [02](../lesson-02-agile-scrum-kanban/) | Agile, Scrum & Kanban | Làm việc theo *nhịp lặp* trong nhóm ra sao? |
| [03](../lesson-03-requirements-spec/) | Yêu cầu & đặc tả | Làm sao biết phải xây *đúng cái gì*? |
