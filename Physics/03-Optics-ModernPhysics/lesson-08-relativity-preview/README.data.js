...
- Hiểu **$E = mc^2$** — phương trình nổi tiếng nhất vật lý.
- Biết khi nào dùng tương đối ($v$ gần $c$) và khi nào dùng Newton ($v \\ll c$).
...
2. **Bất biến tốc độ ánh sáng**: Tốc độ ánh sáng **$c = 3 \\times 10^8\\ \\text{m/s}$** trong chân không **giống nhau cho mọi quan sát viên**, bất kể họ chuyển động thế nào hay nguồn ánh sáng chuyển động thế nào.
...
- *"Vì sao Galileo/Newton cộng vận tốc lại sai?"* Không hẳn sai — chỉ là xấp xỉ rất tốt khi $v \\ll c$. Ở $v$ gần $c$, công thức cộng vận tốc cổ điển sụp đổ, phải dùng công thức tương đối.
...
1. Đúng **$c$** ($3 \\times 10^8\\ \\text{m/s}$) — KHÔNG phải $1{,}6c$. Tốc độ ánh sáng bất biến với mọi quan sát viên.
...
- Cộng vận tốc Newton chỉ là xấp xỉ khi $v \\ll c$.
...
$$\\Delta t' = \\frac{\\Delta t}{\\sqrt{1 - v^2/c^2}} = \\gamma \\cdot \\Delta t$$

trong đó $\\gamma = \\frac{1}{\\sqrt{1 - v^2/c^2}}$ = **hệ số Lorentz**.
...
**Định nghĩa đầy đủ — hệ số Lorentz $\\gamma$**:
- **(a) Là gì**: hệ số KHÔNG đơn vị $\\gamma = \\frac{1}{\\sqrt{1 - v^2/c^2}}$, luôn $\\geq 1$, cho biết thời gian dãn / độ dài co bao nhiêu lần. $v = 0 \\to \\gamma = 1$ (không hiệu ứng); $v \\to c \\to \\gamma \\to \\infty$.
- **(b) Vì sao cần**: $\\gamma$ là "số nhân" gói trọn mọi hiệu ứng tương đối — nhân vào $\\Delta t$ (dãn thời gian), chia vào $L$ (co độ dài), nhân vào khối lượng-năng lượng. Một con số, dùng cho tất cả.
- **(c) Ví dụ số kèm đơn vị**: $v = 0{,}8c \\to \\gamma = \\frac{1}{\\sqrt{1 - 0{,}64}} = \\frac{1}{\\sqrt{0{,}36}} = \\frac{1}{0{,}6} \\approx 1{,}667$. Nghĩa là đồng hồ bay $0{,}8c$ chạy chậm 1.667 lần; 1 giây của nó = 1.667 giây của người đứng yên.

### 2.1. Ví dụ

**Phi hành gia bay với $v = 0{,}9c$ trong 10 năm (theo đồng hồ của họ)**. Đồng hồ Trái Đất chạy bao nhiêu năm?
- $\\gamma = \\frac{1}{\\sqrt{1 - 0{,}81}} = \\frac{1}{\\sqrt{0{,}19}} \\approx 2{,}29$.
- Trái Đất: $10 \\times 2{,}29 =$ **22,9 năm** đã trôi.
...
- **Muon trong tia vũ trụ**: muon có chu kỳ phân rã $2{,}2\\ \\mu\\text{s}$. Sinh ra ở 60 km trên cao, nếu không có dãn thời gian, chỉ đi được 660 m trước khi tan rã. Nhưng thực tế chúng tới mặt đất → dãn thời gian thật.
...
- *"$\\Delta t$ và $\\Delta t'$ cái nào là thời gian của người chuyển động?"* $\\Delta t$ (thời gian riêng) đo bởi đồng hồ ĐI CÙNG sự kiện (trên phi thuyền). $\\Delta t' = \\gamma \\Delta t$ là thời gian DÀI HƠN đo bởi người đứng yên nhìn theo. Người bay già chậm hơn.
...
- **Đảo $\\Delta t$ và $\\Delta t'$.** Thời gian riêng (đo trên vật chuyển động) là NGẮN nhất. Người ngoài đo được thời gian DÀI hơn ($\\times \\gamma$). Nhầm chiều → kết luận ngược (tưởng người bay già nhanh hơn).
- **Áp công thức khi $v \\ll c$ rồi ngạc nhiên thấy hiệu ứng ~0.** Đúng vậy — ở tốc độ thường $\\gamma \\approx 1$, dãn thời gian không đáng kể. Đó là lý do đời sống hằng ngày không thấy.

🔁 **Dừng lại tự kiểm tra**

1. Phi hành gia bay $v = 0{,}6c$ trong 8 năm theo đồng hồ riêng. Trên Trái Đất trôi qua bao lâu? ($\\gamma$ ở $0{,}6c$ ?)
2. Trong hai người (một bay nhanh, một ở yên), ai già chậm hơn?

<details><summary>Đáp án</summary>

1. $\\gamma = \\frac{1}{\\sqrt{1 - 0{,}36}} = \\frac{1}{\\sqrt{0{,}64}} = \\frac{1}{0{,}8} = 1{,}25$. Trái Đất: $8 \\times 1{,}25 = 10$ năm.
...
- Dãn thời gian: $\\Delta t' = \\gamma \\Delta t$, đồng hồ chuyển động chạy chậm.
- Hệ số Lorentz $\\gamma = \\frac{1}{\\sqrt{1 - v^2/c^2}} \\geq 1$; $v=0 \\to \\gamma=1$, $v \\to c \\to \\gamma \\to \\infty$.
...
$$L = L_0 \\cdot \\sqrt{1 - v^2/c^2} = \\frac{L_0}{\\gamma}$$
...
- *"$L_0$ là độ dài nào?"* $L_0$ = độ dài RIÊNG, đo trong hệ vật đứng yên (dài nhất). Người thấy vật chuyển động đo được $L = L_0/\\gamma$ ngắn hơn.
...
- **Nhân thay vì chia $\\gamma$.** Độ dài CO lại: $L = L_0/\\gamma$ (chia, ra ngắn hơn). Thời gian DÃN ra: $\\Delta t' = \\gamma \\Delta t$ (nhân, ra dài hơn). Lẫn hai cái → sai chiều.
- **Co cả chiều vuông góc.** Không — chỉ chiều dọc theo vận tốc bị co.

🔁 **Dừng lại tự kiểm tra**

1. Phi thuyền dài 100 m (đứng yên) bay $v = 0{,}8c$ ($\\gamma = 1{,}667$). Người ở Trái Đất đo dài bao nhiêu?
2. Một quả cầu bay nhanh — người đứng yên thấy nó thành hình gì?

<details><summary>Đáp án</summary>

1. $L = L_0/\\gamma = 100/1{,}667 \\approx 60\\ \\text{m}$.
...
- Co độ dài: $L = L_0/\\gamma$, vật chuyển động ngắn lại theo chiều di chuyển.
- Chỉ co theo phương chuyển động; phương vuông góc không đổi.
- Độ dài riêng $L_0$ (đo trong hệ vật) là dài nhất.
...
**1 gam khối lượng = ?**
- $E = 0{,}001 \\times (3 \\times 10^8)^2 =$ **$9 \\times 10^{13}\\ \\text{J}$** $= 90\\ \\text{TJ}$.
- Đủ điện cho **20,000 hộ gia đình trong 1 năm**.
- Bom Hiroshima (~ 15 kt TNT) tương đương ~ 0.7 gam khối lượng chuyển hóa.

Đó là tại sao phản ứng hạt nhân (chuyển $m \\to E$ theo công thức này) cực kỳ mạnh.

❓ **Câu hỏi tự nhiên của người đọc**

- *"Vì sao một lượng khối lượng nhỏ cho năng lượng khổng lồ?"* Vì hệ số $c^2 = 9 \\times 10^{16}$ cực lớn. Chỉ 1 g (0.001 kg) cho $E = 0{,}001 \\times 9 \\times 10^{16} = 9 \\times 10^{13}\\ \\text{J} = 90\\ \\text{TJ}$. $c^2$ là "tỉ giá quy đổi" khối lượng ↔ năng lượng, rất cao.
- *"$E = mc^2$ áp dụng cho mọi thứ hay chỉ phản ứng hạt nhân?"* Mọi thứ — cả phản ứng hóa học cũng giảm khối lượng cực nhỏ. Nhưng chỉ phản ứng HẠT NHÂN có $\\Delta m$ đủ lớn để đo và khai thác (hụt khối ~0.1%, gấp triệu lần hóa học).
...
- **Quên bình phương c.** $E = mc^2$, KHÔNG phải $mc$. Bỏ bình phương → sai 8 bậc độ lớn.
- **Lẫn đơn vị: $m$ phải tính bằng kg.** Đề cho gram phải đổi sang kg ($1\\ \\text{g} = 0{,}001\\ \\text{kg}$) trước khi thay vào, nếu không sai 1000 lần.
...
1. $E = mc^2 = 0{,}002 \\times (3 \\times 10^8)^2 = 0{,}002 \\times 9 \\times 10^{16} = 1{,}8 \\times 10^{14}\\ \\text{J}$.
2. Vì độ hụt khối $\\Delta m$ trong phản ứng hạt nhân (~0.1% khối lượng) lớn hơn hóa học ($\\sim 10^{-9}$) khoảng triệu lần. Nhân với $c^2$ khổng lồ → năng lượng lớn hơn triệu lần.

</details>

### 📝 Tóm tắt mục 4

- $E = mc^2$: khối lượng và năng lượng là hai dạng của cùng một thứ.
- $c^2$ là "tỉ giá quy đổi" cực lớn → khối lượng nhỏ cho năng lượng khổng lồ ($1\\ \\text{g} = 9 \\times 10^{13}\\ \\text{J}$).
...
| $1{,}0$ | $\\infty$ | Chỉ đạt được cho photon |

→ Trong đời sống thường ngày ($v \\leq 1000\\ \\text{km/h}$), $v/c \\sim 10^{-6}$ → Newton chính xác đến vài ppm. Chỉ ở quy mô hạt cao năng (máy gia tốc), GPS (chính xác cao), du hành vũ trụ tốc độ cao mới cần Einstein.

💡 **Trực giác**: Einstein không "phủ nhận" Newton — Newton là TRƯỜNG HỢP RIÊNG của Einstein khi $v \\ll c$ ($\\gamma \\approx 1$). Giống như bản đồ phẳng vẫn dùng tốt cho khu phố, chỉ sai khi vẽ cả Trái Đất cong.

❓ **Câu hỏi tự nhiên của người đọc**

- *"Khi nào BẮT BUỘC dùng Einstein?"* Khi $v$ đủ gần $c$ để $\\gamma$ lệch đáng kể khỏi 1 — thường từ ~10% $c$ trở lên ($\\gamma \\approx 1{,}005$, sai số 0.5%). Hạt trong máy gia tốc, tia vũ trụ, electron tốc độ cao.
...
- *"$v/c$ của máy bay phản lực bằng bao nhiêu?"* ~1000 km/h $\\approx 280\\ \\text{m/s}$ → $v/c \\approx 10^{-6}$ → $\\gamma$ lệch khỏi 1 chỉ $\\sim 10^{-12}$ → hoàn toàn bỏ qua được, Newton chính xác.

⚠ **Lỗi thường gặp**

- **Dùng Newton cho hạt gần c.** Ở $v = 0{,}9c$, Newton sai hoàn toàn ($\\gamma = 2{,}29$). Phải dùng Einstein.
- **Tưởng GPS không cần tương đối vì vệ tinh 'chậm'.** Sai — yêu cầu độ chính xác cực cao khuếch đại hiệu ứng nhỏ thành lỗi km/ngày.

🔁 **Dừng lại tự kiểm tra**

1. Một electron đi $v = 0{,}99c$. Dùng Newton hay Einstein? ($\\gamma \\approx ?$)
2. Vì sao ta không cảm nhận hiệu ứng tương đối khi đi máy bay?

<details><summary>Đáp án</summary>

1. $\\gamma = \\frac{1}{\\sqrt{1 - 0{,}9801}} = \\frac{1}{\\sqrt{0{,}0199}} \\approx 7{,}09$ → lệch xa 1 → **bắt buộc Einstein**.
2. $v$ máy bay ~280 m/s, $v/c \\approx 10^{-6}$ → $\\gamma \\approx 1$ tới $\\sim 10^{-12}$ → hiệu ứng nhỏ hơn mọi khả năng cảm nhận; Newton chính xác.

</details>

### 📝 Tóm tắt mục 5

- Newton là trường hợp riêng của Einstein khi $v \\ll c$ ($\\gamma \\approx 1$).
- Cần Einstein khi $v \\gtrsim 10\\%\\ c$ (máy gia tốc, tia vũ trụ) hoặc khi đòi độ chính xác cực cao (GPS).
- Đời sống thường ($v/c \\sim 10^{-6}$): Newton chính xác tới vài ppm.
...
**Bài 1**: $\\gamma = \\frac{1}{\\sqrt{1 - 0{,}64}} = \\frac{1}{\\sqrt{0{,}36}} = \\frac{1}{0{,}6} =$ **$5/3 \\approx 1{,}667$**.

**Bài 2**: $\\gamma = \\frac{1}{\\sqrt{1 - 0{,}9025}} = \\frac{1}{\\sqrt{0{,}0975}} \\approx 3{,}2$. Đồng hồ Trái Đất: $5 \\times 3{,}2 =$ **16 năm**.

**Bài 3**: $E = 1 \\cdot (3 \\times 10^8)^2 =$ **$9 \\times 10^{16}\\ \\text{J} = 90\\ \\text{PJ}$**. Đủ cho cả thành phố lớn dùng vài tháng.

**Bài 4**: $\\gamma = \\frac{1}{\\sqrt{1 - v^2/c^2}}$. Khi $v \\to c$, $\\gamma \\to \\infty$. Năng lượng cần để gia tốc tiếp $= \\gamma \\cdot mc^2 \\to \\infty$ → cần năng lượng vô hạn. Chỉ photon ($m = 0$) đạt được $c$.
...
2. **Dãn thời gian**: $\\Delta t' = \\gamma \\cdot \\Delta t$. Đồng hồ chuyển động chạy chậm.
3. **Co độ dài**: $L = L_0/\\gamma$. Vật chuyển động ngắn lại theo chiều di chuyển.
4. **$E = mc^2$**: $m$ và $E$ là 2 dạng của cùng 1 thứ. $1\\ \\text{g} = 9 \\times 10^{13}\\ \\text{J}$.
