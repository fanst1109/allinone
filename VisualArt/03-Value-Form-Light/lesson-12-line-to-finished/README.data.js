...
// Source: VisualArt/03-Value-Form-Light/lesson-12-line-to-finished/README.md
// Chạy lại: go run tools/build-readme-data.go
window.README_MD = `# Lesson 12 — Từ phác thảo đến tranh hoàn chỉnh (Line → Value → Color → Finish)
