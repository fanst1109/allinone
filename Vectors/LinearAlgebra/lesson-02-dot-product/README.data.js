...
// Source: Vectors/LinearAlgebra/lesson-02-dot-product/README.md
...
- [Tầng 2 Lesson 05 — Identities + Định lý cosin](../../Trigonometry/lesson-05-identities-cosine-law/): chính thức công thức \`c² = a² + b² − 2ab·cosC\`. Định lý này là cây cầu nối định nghĩa đại số và hình học của dot product.
- [Tầng 2 Lesson 03 — Đường tròn đơn vị](../../Trigonometry/lesson-03-unit-circle/): biết \`cosθ ∈ [-1, 1]\`.
...
**Reference Tầng 2**:
- [Lesson 05 — Cosine law](../../Trigonometry/lesson-05-identities-cosine-law/): cơ sở chứng minh hai định nghĩa dot product.
- [Lesson 03 — Đường tròn đơn vị](../../Trigonometry/lesson-03-unit-circle/): \`cosθ ∈ [-1, 1]\`.
