...
// Source: Vectors/LinearAlgebra/lesson-01-vectors/README.md
...
- [Algebra Lesson 05 — Functions](../../Algebra/lesson-05-functions/) — hàm số \`f: A → B\`, tập xác định, tập giá trị. Phép toán trên vector cũng là một loại hàm: \`+: ℝⁿ × ℝⁿ → ℝⁿ\`.
- [Trigonometry Lesson 06 — Rotation matrix](../../Trigonometry/lesson-06-rotation-matrix/) — đã thấy "ma trận tác động lên vector 2D" để xoay. Bài này định nghĩa lại vector chính thức để Lesson 05-06 phía sau định nghĩa ma trận đúng nghĩa.
- [Calculus Lesson 06 — Gradient](../../Calculus/lesson-06-partial-gradient/) — gradient \`∇f\` đã được dùng như một "vector gồm các đạo hàm riêng". Bài này làm rõ nó là vector trong ℝⁿ.
- (Hữu ích) [Trigonometry Lesson 02 — sin/cos](../../Trigonometry/lesson-02-sin-cos-tan/) — sẽ cần khi nói tới góc giữa hai vector (Lesson 02 LinearAlgebra).
...
Đã thấy ở [Calculus Lesson 06](../../Calculus/lesson-06-partial-gradient/). Gradient \`∇f\` là một vector trong ℝⁿ với \`n\` = số tham số:
