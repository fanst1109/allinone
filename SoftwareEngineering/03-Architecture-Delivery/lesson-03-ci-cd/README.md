# Lesson 03 — CI/CD (tích hợp & triển khai liên tục)
...
- **Chiến lược kiểm thử** — CI chỉ mạnh khi có **test tự động** đủ tốt làm "lưới an toàn". Xem [Lesson 06 — Chiến lược kiểm thử](../../02-Design-Quality/lesson-06-chien-luoc-kiem-thu/).
...
Tổng: lỗi bị bắt sau ~73 giây, *trước khi* lên nhánh chính. So với việc lỗi VAT này lọt lên production (xem đường cong chi phí ở [Lesson 01 — SDLC](../../01-Foundations/lesson-01-sdlc-vai-tro-ky-su/)) — rẻ hơn gấp bội.
...
- [Lesson 04 — Container & triển khai](../lesson-04-container-trien-khai/) — đóng gói ứng dụng bằng container để bản build chạy *giống hệt nhau* ở mọi môi trường, nền tảng cho việc triển khai mà pipeline CI/CD ở bài này điều phối.
- Liên quan: [Lesson 05 — Observability & độ tin cậy](../lesson-05-observability-do-tin-cay/) — giám sát chính là "lưới an toàn" giúp canary/Continuous Deployment chạy an toàn.
