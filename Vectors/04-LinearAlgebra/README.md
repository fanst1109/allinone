...
- [Tầng 1 Algebra](../01-Algebra/): hàm số, hệ phương trình tuyến tính (Lesson 08).
- [Tầng 2 Trigonometry](../02-Trigonometry/): rotation matrix (Lesson 06), cosine similarity preview (Lesson 05).
- [Tầng 3 Calculus](../03-Calculus/): gradient (Lesson 06), gradient descent (Lesson 07).
