...
1. Hợp thành 1 **đường thẳng** (2 tia đối nhau ghép lại). Góc giữa chúng = 180° (góc bẹt).
...
- *"Bỏ tiên đề 5 thì hình học còn đúng không?"* Vẫn đúng, nhưng là **hình học khác**. Trên mặt cầu (như Trái Đất), qua 1 điểm ngoài 1 "đường thẳng" (vòng tròn lớn) **không có** đường song song nào — mọi vòng tròn lớn đều cắt nhau. Tổng 3 góc tam giác trên cầu **> 180°**.
...
2. Trên mặt cầu, tổng 3 góc của một tam giác lớn hơn hay nhỏ hơn 180°?

<details><summary>Đáp án</summary>

1. Tiên đề 3.
2. **Lớn hơn** 180° (hình học cầu — phi Euclid). Vd tam giác có 3 đỉnh tạo bởi 3 góc vuông trên cầu có tổng = 270°.
...
- Bỏ/đổi tiên đề 5 → hình học phi Euclid (cầu: tổng góc tam giác > 180°; hyperbolic: < 180°).
...
💡 **Trực giác / Hình dung**: góc đo "độ mở" giữa 2 tia chung gốc — như độ mở của 2 cánh kéo hay 2 kim đồng hồ. Mở càng rộng → góc càng lớn. Đơn vị độ chia 1 vòng tròn đầy thành 360 phần bằng nhau (1° = 1/360 vòng). Kim phút quay từ 12 tới 3 quét đúng 90° (1/4 vòng).
...
- Góc 35°: nhọn (0 < 35 < 90). Góc bù = 145°, góc phụ = 55°.
- Góc 90°: vuông. Góc bù = 90° (bù với chính loại), không có góc phụ dương (90 − 90 = 0).
- Góc 120°: tù (90 < 120 < 180). Góc bù = 60°, không có góc phụ (vì > 90°).
- Góc 250°: phản (180 < 250 < 360). Không có góc bù/phụ trong [0,180].

❓ **Câu hỏi tự nhiên của người đọc**

- *"Bù và phụ dễ nhầm — mẹo nào nhớ?"* "**Phụ** = **P**hần nhỏ → 90°"; "**Bù** = đầy nửa vòng → 180°". Hoặc: bù lớn hơn (chữ "bù" có dấu huyền nặng hơn → số lớn hơn).
- *"Góc tù có góc phụ không?"* Không. Góc phụ cần tổng = 90°, mà góc tù đã > 90° → "góc phụ" sẽ âm, không tồn tại.
- *"Đối đỉnh khác kề bù chỗ nào?"* 2 đường cắt nhau tạo 4 góc: 2 cặp **đối đỉnh** (bằng nhau, không chung cạnh), còn mỗi góc với góc **kề** nó tạo cặp **kề bù** (tổng 180°, chung 1 cạnh).

⚠ **Lỗi thường gặp**: nhầm "so le trong" với "trong cùng phía". So le trong (nằm 2 phía của đường cắt) thì **bằng nhau**; trong cùng phía (cùng 1 phía của đường cắt) thì **bù nhau** (tổng 180°). Phản ví dụ: nếu so le trong là 70° thì so le trong còn lại cũng 70° (không phải 110°); nhưng trong cùng phía của góc 70° là 110°.

🔁 **Dừng lại tự kiểm tra**

1. Góc 63° có góc bù và góc phụ là bao nhiêu?
2. a // b bị cắt bởi c. Một góc trong cùng phía bằng 130°. Góc trong cùng phía còn lại bằng bao nhiêu?

<details><summary>Đáp án</summary>

1. Bù = 180 − 63 = **117°**; phụ = 90 − 63 = **27°**.
2. Trong cùng phía bù nhau → 180 − 130 = **50°**.
...
- **Bù** = tổng 180°; **phụ** = tổng 90°; **đối đỉnh** = bằng nhau.
...
💡 **Trực giác / Hình dung**: hai đường **song song** giống 2 thanh ray đường tàu — luôn cách nhau cố định, không bao giờ gặp dù kéo dài bao xa. Hai đường **vuông góc** giống góc tường gặp sàn — tạo góc "vuông vức" 90°, là góc "ngay ngắn" nhất.

❓ **Câu hỏi tự nhiên của người đọc**

- *"Vì sao 2 đường cùng vuông góc với đường thứ 3 lại song song?"* Vì cả hai đều tạo góc 90° với đường thứ 3 → các góc đồng vị bằng nhau (đều 90°) → theo dấu hiệu nhận biết, 2 đường song song. Hình dung: 2 cây cột cùng dựng thẳng đứng (vuông góc với mặt đất) thì song song nhau.
- *"Song song có 'bắc cầu' như dấu bằng không?"* Có: a // b và b // c → a // c. Đây là tính chất bắc cầu (transitivity), giống a = b và b = c → a = c.
...
2. Ký hiệu ⊥ và // lần lượt nghĩa là gì?

<details><summary>Đáp án</summary>

1. a // b (song song) — hai đường cùng vuông góc với đường thứ 3 trong mặt phẳng thì song song.
2. ⊥ = vuông góc (góc 90°); // = song song (không cắt nhau).

</details>

### 📝 Tóm tắt mục 4

- ⊥ (vuông góc): 2 đường tạo góc 90°. // (song song): không cắt nhau (trong mặt phẳng).
- Qua 1 điểm có **đúng 1** đường vuông góc với đường cho trước.
- 2 đường cùng ⊥ đường thứ 3 → // nhau; // có tính bắc cầu.
